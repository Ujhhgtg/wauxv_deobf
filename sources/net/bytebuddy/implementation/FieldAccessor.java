...
public abstract class FieldAccessor implements Implementation {
    ...
    public interface FieldLocation {
        ...
        public static class Relative implements FieldLocation {
            ...
            public static class Prepared implements Prepared {
                ...
                public int hashCode() {
                    return this.fieldLocator.hashCode() + bjs.g(this.fieldNameExtractors, getClass().hashCode() * 31, 31);
                }
            ...
            public int hashCode() {
                return this.fieldLocatorFactory.hashCode() + bjs.g(this.fieldNameExtractors, getClass().hashCode() * 31, 31);
            }
    ...
    public static abstract class ForSetter<T> extends FieldAccessor implements Implementation.Composable {
        ...
        public static class OfReferenceValue extends ForSetter<FieldDescription.InDefinedShape> {
            ...
            @Override // net.bytebuddy.dynamic.scaffold.InstrumentedType.Prepareable
            public InstrumentedType prepare(InstrumentedType instrumentedType) {
                return instrumentedType.withAuxiliaryField(new FieldDescription.Token(this.name, q.a.i, TypeDescription.ForLoadedType.of(this.value.getClass()).asGenericType()), this.value);
            }
        ...
        public enum TerminationHandler {
            RETURNING { // from class: net.bytebuddy.implementation.FieldAccessor.ForSetter.TerminationHandler.1
                ...
                public StackManipulation resolve(MethodDescription methodDescription) {
                    ...
                    throw new IllegalStateException(dkz.t("Cannot implement setter with return value for ", methodDescription));
                }
            },
    ...
    public int hashCode() {
        return this.typing.hashCode() + dkz.h(this.assigner, (this.fieldLocation.hashCode() + (getClass().hashCode() * 31)) * 31, 31);
    }
