...
public class ToStringMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.fieldDescriptions.hashCode() + bjs.e(this.definer, bjs.e(this.separator, bjs.e(this.end, bjs.e(this.start, bjs.e(this.prefix, getClass().hashCode() * 31, 31), 31), 31), 31), 31);
        }
    }
    ...
    public int hashCode() {
        return this.ignored.hashCode() + bjs.e(this.definer, bjs.e(this.separator, bjs.e(this.end, bjs.e(this.start, (this.prefixResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31), 31), 31), 31);
    }
