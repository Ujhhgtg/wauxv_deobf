...
public class MethodDelegation implements Implementation.Composable {
    ...
    public interface ImplementationDelegate extends InstrumentedType.Prepareable {
        ...
        public static abstract class ForField implements ImplementationDelegate {
            ...
            public int hashCode() {
                return this.matcher.hashCode() + bjs.g(this.parameterBinders, (this.methodGraphCompiler.hashCode() + bjs.e(this.fieldName, getClass().hashCode() * 31, 31)) * 31, 31);
            }
        ...
        public static class ForMethodReturn implements ImplementationDelegate {
            ...
            public int hashCode() {
                return this.matcher.hashCode() + bjs.g(this.parameterBinders, (this.methodGraphCompiler.hashCode() + bjs.e(this.name, getClass().hashCode() * 31, 31)) * 31, 31);
            }
    ...
    public static class WithCustomProperties {
        ...
        public int hashCode() {
            return this.matcher.hashCode() + ((this.bindingResolver.hashCode() + bjs.g(this.parameterBinders, (this.ambiguityResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31);
        }
    ...
    public int hashCode() {
        return this.assigner.hashCode() + ((this.bindingResolver.hashCode() + ((this.terminationHandler.hashCode() + ((this.ambiguityResolver.hashCode() + bjs.g(this.parameterBinders, (this.implementationDelegate.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31)) * 31)) * 31);
    }
