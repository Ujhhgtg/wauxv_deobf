...
public class ModifierAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public int hashCode() {
        return this.methodAdjustments.hashCode() + bjs.g(this.fieldAdjustments, bjs.g(this.typeAdjustments, getClass().hashCode() * 31, 31), 31);
    }
