...
public final class MainActivity extends dg {
    ...
    public MainActivity() {
        super(byz.a);
        this.at = cnb.z(-391400369683242L);
    }
    ...
    public final void av() {
        ...
        if (((ShapeableImageView) cnd.aq(viewInflate, R.id.aboutImageViewIcon)) != null) {
            i = R.id.aboutTextViewDesc;
            MaterialTextView materialTextView = (MaterialTextView) cnd.aq(viewInflate, R.id.aboutTextViewDesc);
            if (materialTextView != null) {
                ...
                if (materialTextView2 != null) {
                    ...
                    if (materialTextView3 != null) {
                        ...
                        materialTextView2.setText(cnb.z(-390438297008938L));
                        materialTextView3.setText(cnb.z(-390408232237866L));
                        materialTextView.setMovementMethod(LinkMovementMethod.getInstance());
                        materialTextView.setText(Html.fromHtml(cnb.z(-390356692630314L), 0));
        ...
        throw new NullPointerException(cnb.z(-634611482753834L).concat(viewInflate.getResources().getResourceName(i)));
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        bhq bhqVar = bhq.a;
        String strZ = cnb.z(-391292995500842L);
        final int i = 0;
        ...
        bzo.n(eqjVar2);
        ((dj) eqjVar2).l.setTitle(cnb.z(-391241455893290L));
        ...
        if (exl.a) {
            ...
            bzo.n(eqjVar8);
            ((dj) eqjVar8).i.setText(cnb.z(-391159851514666L));
        ...
        bzo.n(eqjVar15);
        ((dj) eqjVar15).i.setText(cnb.z(-390558556093226L));
