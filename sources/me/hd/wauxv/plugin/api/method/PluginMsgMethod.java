...
import me.hd.wauxv.obf.StillAnotherHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg;
...
public final class PluginMsgMethod {
    ...
    public final void sendAppBrandMsg(String str, String str2, String str3, String str4) throws JSONException {
        ...
        String strZ = "msg" /* "msg" /* "msg" /* cnb.z(-115100828564266L)  */;
        JSONObject jSONObject2 = new JSONObject();
        String strZ2 = "appmsg" /* "appmsg" /* "appmsg" /* cnb.z(-115049288956714L)  */;
        JSONObject jSONObject3 = new JSONObject();
        jSONObject3.put("type" /* "type" /* "type" /* cnb.z(-115019224185642L)  */, 33);
        jSONObject3.put("title" /* "title" /* "title" /* cnb.z(-115032109087530L)  */, str2);
        String strZ3 = "weappinfo" /* "weappinfo" /* "weappinfo" /* cnb.z(-114989159414570L)  */;
        JSONObject jSONObject4 = new JSONObject();
        String strZ4 = "item" /* "item" /* "item" /* cnb.z(-114963389610794L)  */;
        JSONObject jSONObject5 = new JSONObject();
        jSONObject5.put("pagepath" /* "pagepath" /* "pagepath" /* cnb.z(-114924734905130L)  */,
                "<![CDATA[" /* "<![CDATA[" /* "<![CDATA[" /* cnb.z(-115435836013354L)  */ + str3 + "]]>" /* "]]>" /* "]]>" /* cnb.z(-115410066209578L)  */);
        jSONObject5.put("username" /* "username" /* "username" /* cnb.z(-115358526602026L)  */, str4);
    ...
    public final void sendCipherMsg(String str, String str2, String str3) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        String strZ = "msg" /* "msg" /* "msg" /* cnb.z(-117699283778346L)  */;
        JSONObject jSONObject2 = new JSONObject();
        String strZ2 = "appmsg" /* "appmsg" /* "appmsg" /* cnb.z(-117716463647530L)  */;
        JSONObject jSONObject3 = new JSONObject();
        jSONObject3.put("type" /* "type" /* "type" /* cnb.z(-117669219007274L)  */, 1);
        jSONObject3.put("title" /* "title" /* "title" /* cnb.z(-118180320115498L)  */, str2);
        jSONObject3.put("des" /* "des" /* "des" /* cnb.z(-118137370442538L)  */, str2);
        jSONObject3.put("content" /* "content" /* "content" /* cnb.z(-118154550311722L)  */,
                "|WA|" /* "|WA|" /* "|WA|" /* cnb.z(-118120190573354L)  */ + TextUtils.htmlEncode(str3));
        jSONObject2.put(strZ2, jSONObject3);
        jSONObject.put(strZ, jSONObject2);
        HashSet hashSet = new HashSet();
        HashSet hashSet2 = new HashSet();
    ...
    public final void sendNoteMsg(String str, String str2) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        String strZ = "msg" /* "msg" /* "msg" /* cnb.z(-115337051765546L)  */;
        JSONObject jSONObject2 = new JSONObject();
        String strZ2 = "appmsg" /* "appmsg" /* "appmsg" /* cnb.z(-115285512157994L)  */;
        JSONObject jSONObject3 = new JSONObject();
        jSONObject3.put("type" /* "type" /* "type" /* cnb.z(-115306986994474L)  */, 53);
        jSONObject3.put("title" /* "title" /* "title" /* cnb.z(-115268332288810L)  */, str2);
        String strZ3 = "extinfo" /* "extinfo" /* "extinfo" /* cnb.z(-115225382615850L)  */;
        JSONObject jSONObject4 = new JSONObject();
        jSONObject4.put("solitaire_info" /* "solitaire_info" /* "solitaire_info" /* cnb.z(-115191022877482L)  */, "" /* "" /* "" /* cnb.z(-114559662684970L)  */);
        jSONObject3.put(strZ3, jSONObject4);
        jSONObject2.put(strZ2, jSONObject3);
        jSONObject.put(strZ, jSONObject2);
        HashSet hashSet = new HashSet();
        HashSet hashSet2 = new HashSet();
        hashSet.add("/msg/appmsg/appid" /* "/msg/appmsg/appid" /* "/msg/appmsg/appid" /* cnb.z(-114572547586858L)  */);
        bsr bsrVar = new bsr();
        bsrVar.b = jSONObject;
        bsrVar.c = hashSet;
        bsrVar.d = hashSet2;
    ...
    public final void sendQuoteMsg(String str, long j, String str2) throws JSONException {
        ...
        JSONObject jSONObject = new JSONObject();
        String strZ = "msg" /* "msg" /* "msg" /* cnb.z(-114512418044714L)  */;
        JSONObject jSONObject2 = new JSONObject();
        String strZ2 = "appmsg" /* "appmsg" /* "appmsg" /* cnb.z(-114460878437162L)  */;
        JSONObject jSONObject3 = new JSONObject();
        jSONObject3.put("type" /* "type" /* "type" /* cnb.z(-114482353273642L)  */, 57);
        jSONObject3.put("title" /* "title" /* "title" /* cnb.z(-114443698567978L)  */, str2);
        String strZ3 = "refermsg" /* "refermsg" /* "refermsg" /* cnb.z(-114400748895018L)  */;
        JSONObject jSONObject4 = new JSONObject();
        String strZ4 = "type" /* "type" /* "type" /* cnb.z(-114362094189354L)  */;
        kd kdVar = kd.a;
        ...
        jSONObject4.put("fromusr" /* "fromusr" /* "fromusr" /* cnb.z(-114898965101354L)  */, msgInfoBean.getTalker());
        jSONObject4.put("chatusr" /* "chatusr" /* "chatusr" /* cnb.z(-114864605362986L)  */, msgInfoBean.getSendTalker());
        String strZ5 = "displayname" /* "displayname" /* "displayname" /* cnb.z(-114830245624618L)  */;
        ...
        jSONObject4.put("createtime" /* "createtime" /* "createtime" /* cnb.z(-114649856998186L)  */, msgInfoBean.getCreateTime());
        jSONObject3.put(strZ3, jSONObject4);
        jSONObject2.put(strZ2, jSONObject3);
        jSONObject.put(strZ, jSONObject2);
        HashSet hashSet = new HashSet();
    ...
    public final void sendShareCard(String str, String str2) throws JSONException {
        cly clyVar = cly.a;
        JSONObject jSONObject = new JSONObject();
        String strZ = "msg" /* "msg" /* "msg" /* cnb.z(-116977729272618L)  */;
        JSONObject jSONObject2 = new JSONObject();
        jSONObject2.put("username" /* "username" /* "username" /* cnb.z(-116994909141802L)  */, str2);
        String strZ2 = "nickname" /* "nickname" /* "nickname" /* cnb.z(-116956254436138L)  */;
        Cursor cursorAc = arj
        ...
        HashSet hashSet = new HashSet();
        HashSet hashSet2 = new HashSet();
        hashSet.add("/msg/username" /* "/msg/username" /* "/msg/username" /* cnb.z(-118455198022442L)  */);
        hashSet.add("/msg/nickname" /* "/msg/nickname" /* "/msg/nickname" /* cnb.z(-118377888611114L)  */);
        hashSet.add("/msg/certflag" /* "/msg/certflag" /* "/msg/certflag" /* cnb.z(-118369298676522L)  */);
        bsr bsrVar = new bsr();
        bsrVar.b = jSONObject;
        bsrVar.c = hashSet;
        bsrVar.d = hashSet2;
    ...
    public final void sendTextWithCallBack(String str, String str2, PluginCallBack.SendTextCallback sendTextCallback) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        StillAnotherHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg qVar = new StillAnotherHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg(sendTextCallback, 9);
            ...
            public final Object invoke(Object obj, Method method, Object[] objArr) {
                ...
                if (name != null) {
                    switch (name.hashCode()) {
                        case -1776922004:
                            if (name.equals("toString" /* "toString" /* "toString" /* cnb.z(-134415296494378L)  */)) {
                                return obj.getClass().getName() + '@' + Integer.toHexString(System.identityHashCode(obj));
                            }
                            break;
                        case -1295482945:
                            if (name.equals("equals" /* "equals" /* "equals" /* cnb.z(-134995117079338L)  */)) {
                                return Boolean.valueOf(obj == objArr[0]);
                            }
                            break;
                        case 147696667:
                            if (name.equals("hashCode" /* "hashCode" /* "hashCode" /* cnb.z(-135033771785002L)  */)) {
                                return Integer.valueOf(System.identityHashCode(obj));
                            }
                            break;
                        case 1994440622:
                            if (name.equals("onSceneEnd" /* "onSceneEnd" /* "onSceneEnd" /* cnb.z(-134376641788714L)  */)) {
                                try {
                                    Object obj2 = objArr[0];
                                    throwIfVar1IsNull(obj2, "null cannot be cast to non-null type kotlin.Int" /* "null cannot be cast to non-null type kotlin.Int" /* "null cannot be cast to non-null type kotlin.Int" /* cnb.z(-134295037410090L)  */);
                                    Integer num = (Integer) obj2;
                                    Object obj3 = objArr[1];
                                    throwIfVar1IsNull(obj3, "null cannot be cast to non-null type kotlin.Int" /* "null cannot be cast to non-null type kotlin.Int" /* "null cannot be cast to non-null type kotlin.Int" /* cnb.z(-134638634793770L)  */);
    ...
    public final void sendLocation(String str, JSONObject jSONObject) throws JSONException {
        arj.ae(str, jSONObject.optString("poiName" /* "poiName" /* "poiName" /* cnb.z(-403885839612714L)  */),
                jSONObject.optString("label" /* "label" /* "label" /* cnb.z(-403851479874346L)  */),
                jSONObject.optString("x" /* "x" /* "x" /* cnb.z(-403808530201386L)  */), jSONObject.optString(
                        "y" /* "y" /* "y" /* cnb.z(-403817120135978L)  */),
                jSONObject.optString("scale" /* "scale" /* "scale" /* cnb.z(-403825710070570L)  */));
    }
