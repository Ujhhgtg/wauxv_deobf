...
public final class PluginOtherMethod {
    ...
    public final void log(Object obj) throws IOException {
        ...
        sb.append(cnb.z(-401033981328170L));
        ctx ctxVar = this.a;
        sb.append(ctxVar.f);
        ...
        bmu bmuVar = ctxVar.m;
        bmuVar.s(new cuh(((ctx) bmuVar.h).f, cnb.z(-390322332891946L), String.valueOf(obj)));
    }
    ...
    public final void notify(String str, String str2) {
        ...
        bpy bpyVar = new bpy(cnb.z(-400969556818730L));
        bpyVar.b = cnb.z(-400939492047658L);
    ...
    public final void uploadDeviceStep(long j) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        String strZ2 = cnb.z(-140131897965354L);
