...
import me.hd.wauxv.obf.StorageFeatureService$ClassStorageFeatureService;
...
public final class PluginVipMethod {
    public static void a(IFunction0 bfuVar) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        FieldResolver fieldResolverVarR = dqc.getWrapperConfiguration(objInvoke).createFieldResolver();
