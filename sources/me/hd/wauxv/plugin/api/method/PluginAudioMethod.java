...
public final class PluginAudioMethod {
    ...
    public final File mp3ToSilkFile(String str) throws IOException {
        ...
        cnh.k(file, "mp3ToSilk" /* "mp3ToSilk" /* "mp3ToSilk" /* cnb.z(-398963807091498L)  */);
        File fileX = cnh.x("pcm" /* "pcm" /* "pcm" /* cnb.z(-398938037287722L)  */);
        ...
        File fileX2 = cnh.x("silk" /* "silk" /* "silk" /* cnb.z(-398886497680170L)  */);
