...
public final class esv {
    ...
    static {
        float[] fArr = bhv.h;
        float fAm = (float) ((((double) bhv.am()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = bhv.f;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fAm) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f10 = 1.0f / ((5.0f * fAm) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) fAm) * 5.0d))) + (f11 * fAm);
        float fAm2 = bhv.am() / fArr[1];
        double d2 = fAm2;
        ...
        a = new esv(fAm2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public esv(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.g = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
