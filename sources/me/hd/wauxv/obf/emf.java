...
public abstract class emf {
    ...
    static {
        cnf.an("TypefaceCompat static init");
    ...
    public static Typeface d(Context context, bca bcaVar, Resources resources, int i, String str, int i2, int i3,
        ...
        if (bcaVar instanceof bcd) {
            ...
            if (typefaceBuild != null) {
                if (bhtVar != null) {
                    new Handler(Looper.getMainLooper()).post(new hl(bhtVar, i4, typefaceBuild));
                }
                b.v(e(resources, i, str, i2, i3), typefaceBuild);
                return typefaceBuild;
            }
            Object[] objArr3 = !z ? bhtVar != null : bcdVar.c != 0;
            int i9 = z ? bcdVar.b : -1;
            ...
            if (objArr3 != true) {
                ...
                if (typeface2 != null) {
                    ...
                    try {
                        ...
                        ((dby) ioVar.d).execute(new np((bmu) ioVar.c, i5, i6));
                    }
                }
            }
        } else {
            ...
            if (bhtVar != null) {
                if (typefaceS != null) {
                    new Handler(Looper.getMainLooper()).post(new hl(bhtVar, i4, typefaceS));
                } else {
                    bhtVar.ai(-3);
                }
            }
