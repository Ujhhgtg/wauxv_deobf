...
public final class cyh {
    ...
    public static void g(BigInteger[] bigIntegerArr) {
        ...
        bzo.p(bigIntegerShiftRight, "shiftRight(...)" /* cnb.z(-582796997294890L) */);
        ...
        bzo.p(bigIntegerShiftLeft, "shiftLeft(...)" /* cnb.z(-583179249384234L) */);
        ...
        bzo.p(bigIntegerShiftRight2, "shiftRight(...)" /* cnb.z(-584648128199466L) */);
        ...
        bzo.p(bigIntegerShiftLeft2, "shiftLeft(...)" /* cnb.z(-584463444605738L) */);
        ...
        bzo.p(bigIntegerShiftRight3, "shiftRight(...)" /* cnb.z(-584901531269930L) */);
        ...
        bzo.p(bigIntegerShiftLeft3, "shiftLeft(...)" /* cnb.z(-584734027545386L) */);
        ...
        bzo.p(bigIntegerShiftRight4, "shiftRight(...)" /* cnb.z(-584003883105066L) */);
        ...
        bzo.p(bigIntegerShiftLeft4, "shiftLeft(...)" /* cnb.z(-584368955325226L) */);
    ...
    public final void h() {
        ...
        bzo.p(bigIntegerAdd, "add(...)" /* cnb.z(-584205746567978L) */);
        BigInteger bigInteger = a;
        ...
        for (int i = 0; i < 256; i++) {
            ...
            if (i2 == 0) {
                ...
                bzo.p(bigIntegerShiftLeft, "shiftLeft(...)" /* cnb.z(-584145617025834L) */);
                ...
                bzo.p(bigIntegerShiftRight, "shiftRight(...)" /* cnb.z(-581332413446954L) */);
                ...
                bzo.p(bigIntegerShiftLeft2, "shiftLeft(...)" /* cnb.z(-581263693970218L) */);
                bigIntegerArr[0] = bigInteger4.xor(bigIntegerShiftLeft2);
            } else if (i2 == 3) {
                BigInteger bigInteger5 = bigIntegerArr[0];
                BigInteger bigIntegerShiftRight2 = bigInteger5.shiftRight(33);
                bzo.p(bigIntegerShiftRight2, "shiftRight(...)" /* cnb.z(-581182089591594L) */);
            ...
            bzo.p(bigIntegerShiftRight3, "shiftRight(...)" /* cnb.z(-581641651092266L) */);
            long j = 256;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(j);
            bzo.p(bigIntegerValueOf, "valueOf(...)" /* cnb.z(-581572931615530L) */);
            BigInteger bigIntegerAdd2 = bigIntegerArr2[bigIntegerShiftRight3.mod(bigIntegerValueOf).intValue()].add(bigIntegerArr[0]);
            bzo.p(bigIntegerAdd2, "add(...)" /* cnb.z(-581482737302314L) */);
            ...
            bzo.p(bigIntegerShiftRight4, "shiftRight(...)" /* cnb.z(-581422607760170L) */);
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(j);
            bzo.p(bigIntegerValueOf2, "valueOf(...)" /* cnb.z(-580804132469546L) */);
