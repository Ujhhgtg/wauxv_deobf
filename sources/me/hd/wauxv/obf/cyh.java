...
public final class cyh {
    public static final BigInteger a = new BigInteger("ffffffffffffffff" /* "ffffffffffffffff" /* "ffffffffffffffff" /* cnb.z(-580692463319850L)  */, 16);
    ...
    public cyh(BigInteger bigInteger) {
        ...
        for (int i = 0; i < 8; i++) {
            bigIntegerArr[i] = new BigInteger("9e3779b97f4a7c13" /* "9e3779b97f4a7c13" /* "9e3779b97f4a7c13" /* cnb.z(-582947321150250L)  */, 16);
        }
        ...
        KotlinIntProgression intRangeVarBj = dqc.bj(dqc.bm(0, bigIntegerArr7.length), 8);
        int i6 = intRangeVarBj.first;
        int i7 = intRangeVarBj.last;
        int i8 = intRangeVarBj.step;
        BigInteger bigInteger2 = a;
        if ((i8 > 0 && i6 <= i7) || (i8 < 0 && i7 <= i6)) {
            while (true) {
                for (int i9 = 0; i9 < 8; i9++) {
                    bigIntegerArr6[i9] = bjs.s(-584265876110122L, bigIntegerArr6[i9].add(bigIntegerArr7[i6 + i9]),
                            bigInteger2);
                }
                g(bigIntegerArr6);
        ...
        KotlinIntProgression intRangeVarBj2 = dqc.bj(dqc.bm(0, bigIntegerArr5.length), 8);
        int i11 = intRangeVarBj2.first;
        int i12 = intRangeVarBj2.last;
        int i13 = intRangeVarBj2.step;
        if ((i13 > 0 && i11 <= i12) || (i13 < 0 && i12 <= i11)) {
            while (true) {
                for (int i14 = 0; i14 < 8; i14++) {
                    bigIntegerArr6[i14] = bjs.s(-584244401273642L, bigIntegerArr6[i14].add(bigIntegerArr5[i11 + i14]),
                            bigInteger2);
                }
                g(bigIntegerArr6);
    ...
    public static void g(BigInteger[] bigIntegerArr) {
        ...
        throwIfVar1IsNull(bigIntegerShiftRight, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-582796997294890L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-583179249384234L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight2, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-584648128199466L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft2, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-584463444605738L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight3, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-584901531269930L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft3, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-584734027545386L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight4, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-584003883105066L)  */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft4, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-584368955325226L)  */);
    ...
    public final void h() {
        ...
        throwIfVar1IsNull(bigIntegerAdd, "add(...)" /* "add(...)" /* "add(...)" /* cnb.z(-584205746567978L)  */);
        BigInteger bigInteger = a;
        ...
        for (int i = 0; i < 256; i++) {
            ...
            if (i2 == 0) {
                ...
                throwIfVar1IsNull(bigIntegerShiftLeft, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-584145617025834L)  */);
                ...
                throwIfVar1IsNull(bigIntegerShiftRight, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-581332413446954L)  */);
                ...
                throwIfVar1IsNull(bigIntegerShiftLeft2, "shiftLeft(...)" /* "shiftLeft(...)" /* "shiftLeft(...)" /* cnb.z(-581263693970218L)  */);
                bigIntegerArr[0] = bigInteger4.xor(bigIntegerShiftLeft2);
            } else if (i2 == 3) {
                BigInteger bigInteger5 = bigIntegerArr[0];
                BigInteger bigIntegerShiftRight2 = bigInteger5.shiftRight(33);
                throwIfVar1IsNull(bigIntegerShiftRight2, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-581182089591594L)  */);
            ...
            throwIfVar1IsNull(bigIntegerShiftRight3, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-581641651092266L)  */);
            long j = 256;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(j);
            throwIfVar1IsNull(bigIntegerValueOf, "valueOf(...)" /* "valueOf(...)" /* "valueOf(...)" /* cnb.z(-581572931615530L)  */);
            BigInteger bigIntegerAdd2 = bigIntegerArr2[bigIntegerShiftRight3.mod(bigIntegerValueOf).intValue()]
                    .add(bigIntegerArr[0]);
            throwIfVar1IsNull(bigIntegerAdd2, "add(...)" /* "add(...)" /* "add(...)" /* cnb.z(-581482737302314L)  */);
            ...
            throwIfVar1IsNull(bigIntegerShiftRight4, "shiftRight(...)" /* "shiftRight(...)" /* "shiftRight(...)" /* cnb.z(-581422607760170L)  */);
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(j);
            throwIfVar1IsNull(bigIntegerValueOf2, "valueOf(...)" /* "valueOf(...)" /* "valueOf(...)" /* cnb.z(-580804132469546L)  */);
            bigIntegerArr[1] = bjs.s(-580731118025514L,
                    bigIntegerArr2[bigIntegerShiftRight4.mod(bigIntegerValueOf2).intValue()].add(bigInteger7),
                    bigInteger);
