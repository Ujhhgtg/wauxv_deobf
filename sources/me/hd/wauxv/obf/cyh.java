...
public final class cyh {
    public static final BigInteger a = new BigInteger("ffffffffffffffff" /* cnb.z(-580692463319850L) */, 16);
    ...
    public cyh(BigInteger bigInteger) {
        ...
        for (int i = 0; i < 8; i++) {
            bigIntegerArr[i] = new BigInteger("9e3779b97f4a7c13" /* cnb.z(-582947321150250L) */, 16);
        }
    ...
    public static void g(BigInteger[] bigIntegerArr) {
        ...
        throwIfVar1IsNull(bigIntegerShiftRight, "shiftRight(...)" /* cnb.z(-582796997294890L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft, "shiftLeft(...)" /* cnb.z(-583179249384234L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight2, "shiftRight(...)" /* cnb.z(-584648128199466L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft2, "shiftLeft(...)" /* cnb.z(-584463444605738L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight3, "shiftRight(...)" /* cnb.z(-584901531269930L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft3, "shiftLeft(...)" /* cnb.z(-584734027545386L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftRight4, "shiftRight(...)" /* cnb.z(-584003883105066L) */);
        ...
        throwIfVar1IsNull(bigIntegerShiftLeft4, "shiftLeft(...)" /* cnb.z(-584368955325226L) */);
    ...
    public final void h() {
        ...
        throwIfVar1IsNull(bigIntegerAdd, "add(...)" /* cnb.z(-584205746567978L) */);
        BigInteger bigInteger = a;
        ...
        for (int i = 0; i < 256; i++) {
            ...
            if (i2 == 0) {
                ...
                throwIfVar1IsNull(bigIntegerShiftLeft, "shiftLeft(...)" /* cnb.z(-584145617025834L) */);
                ...
                throwIfVar1IsNull(bigIntegerShiftRight, "shiftRight(...)" /* cnb.z(-581332413446954L) */);
                ...
                throwIfVar1IsNull(bigIntegerShiftLeft2, "shiftLeft(...)" /* cnb.z(-581263693970218L) */);
                bigIntegerArr[0] = bigInteger4.xor(bigIntegerShiftLeft2);
            } else if (i2 == 3) {
                BigInteger bigInteger5 = bigIntegerArr[0];
                BigInteger bigIntegerShiftRight2 = bigInteger5.shiftRight(33);
                throwIfVar1IsNull(bigIntegerShiftRight2, "shiftRight(...)" /* cnb.z(-581182089591594L) */);
            ...
            throwIfVar1IsNull(bigIntegerShiftRight3, "shiftRight(...)" /* cnb.z(-581641651092266L) */);
            long j = 256;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(j);
            throwIfVar1IsNull(bigIntegerValueOf, "valueOf(...)" /* cnb.z(-581572931615530L) */);
            BigInteger bigIntegerAdd2 = bigIntegerArr2[bigIntegerShiftRight3.mod(bigIntegerValueOf).intValue()]
                    .add(bigIntegerArr[0]);
            throwIfVar1IsNull(bigIntegerAdd2, "add(...)" /* cnb.z(-581482737302314L) */);
            ...
            throwIfVar1IsNull(bigIntegerShiftRight4, "shiftRight(...)" /* cnb.z(-581422607760170L) */);
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(j);
            throwIfVar1IsNull(bigIntegerValueOf2, "valueOf(...)" /* cnb.z(-580804132469546L) */);
