...
public final class etg extends doo implements bnl {
    ...
    public final List m() {
        return !z() ? avd.a : aba.ag(new bai(R.id.MenuItem_VideoNumber_CopyLink, "复制链接" /* cnb.z(-610332032629546L) */, R.drawable.ic_menu_copy_24dp, new dfq(15)), new bai(R.id.MenuItem_VideoNumber_Download, "下载视频" /* cnb.z(-610276198054698L) */, R.drawable.ic_menu_save_24dp, new dfq(16)));
    }
