...
public final class AccessibilityDelegateCompat$AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
    ...
    public AccessibilityDelegateCompat$AccessibilityDelegateAdapter(AccessibilityDelegateCompat aqVar) {
        this.a = aqVar;
    }
    ...
    public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        this.a.initializeAccessibilityEvent(view, accessibilityEvent);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence charSequenceK = ViewCompat.k(view);
        if (i >= 28) {
        ...
        this.a.onInitializeAccessibilityNodeInfo(view, bdVar);
    ...
    public final void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        this.a.populateAccessibilityEvent(view, accessibilityEvent);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final boolean onRequestSendAccessibilityEvent(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
        return this.a.requestSendAccessibilityEvent(viewGroup, view, accessibilityEvent);
    }
