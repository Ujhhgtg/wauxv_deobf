...
public abstract class cyj {
    public static final AbstractRandom RANDOM;

    static {
        Integer num = bqz.OS_SDK_INT;
        RANDOM = (num == null || num.intValue() >= 34) ? new RandomOsSdkLt34Impl() : new RandomOsSdkEtOrSt34Impl();
    }
