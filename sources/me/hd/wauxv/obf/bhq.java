...
public final class bhq {
    ...
    static {
        "HdShare" /* "HdShare" /* "HdShare" /* cnb.z(-45492293597994L)  */;
        "WAuxiliary_Public" /* "WAuxiliary_Public" /* "WAuxiliary_Public" /* cnb.z(-45457933859626L)  */;
        a = new bhq();
    }
    ...
    public static final bhm b(bhq bhqVar, String str) {
        ...
        Pattern patternCompile = Pattern.compile("^(\\d+\\.\\d+\\.\\d+)\\.r(\\d+)\\.(\\w+)$" /*
                                                                                              * "^(\\d+\\.\\d+\\.\\d+)\\.r(\\d+)\\.(\\w+)$" /* "^(\\d+\\.\\d+\\.\\d+)\\.r(\\d+)\\.(\\w+)$" /* cnb.z(-45140106279722L)  */
                                                                                              */);
        ...
        if (bzxVar == null) {
            return new bhm("1.0.0" /* "1.0.0" /* "1.0.0" /* cnb.z(-45548128172842L)  */, 1, "standalone" /* "standalone" /* "standalone" /* cnb.z(-45505178499882L)  */);
        }
