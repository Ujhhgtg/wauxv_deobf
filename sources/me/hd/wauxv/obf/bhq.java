...
public final class bhq {
    ...
    static {
        cnb.z(-45492293597994L);
        cnb.z(-45457933859626L);
        a = new bhq();
    }

    public static final bhm b(bhq bhqVar, String str) {
        bhqVar.getClass();
        Pattern patternCompile = Pattern.compile(cnb.z(-45140106279722L));
        ...
        if (bzxVar == null) {
            return new bhm(cnb.z(-45548128172842L), 1, cnb.z(-45505178499882L));
        }
