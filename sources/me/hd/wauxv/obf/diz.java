...
public final class diz extends doo implements boa, bob {
    ...
    public final List a() {
        return !z() ? avd.a : dqc.bf(new djl(R.id.MenuItem_Sns_Like, "伪点赞[WA]" /* cnb.z(-529496453151530L) */, new wx(1)));
    }
    ...
    public final void r(String str, ContentValues contentValues) throws IllegalAccessException {
        if (z() && str.equals("SnsInfo" /* cnb.z(-529462093413162L) */)) {
            ...
            bzo.o(obj, "null cannot be cast to non-null type kotlin.Long" /* cnb.z(-529934539815722L) */);
            ...
            bzo.o(obj2, "null cannot be cast to non-null type kotlin.ByteArray" /* cnb.z(-528989647010602L) */);
