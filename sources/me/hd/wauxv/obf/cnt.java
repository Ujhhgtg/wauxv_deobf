...
public final /* synthetic */ class cnt implements bgx {
    ...
    static {
        cnt cntVar = new cnt();
        b = cntVar;
        cuc cucVar = new cuc("me.hd.wauxv.hook.micromsg.core.protobuf.old.proto.NewSendMsgProto.MicroMsgResponseNew" /* "me.hd.wauxv.hook.micromsg.core.protobuf.old.proto.NewSendMsgProto.MicroMsgResponseNew" /* "me.hd.wauxv.hook.micromsg.core.protobuf.old.proto.NewSendMsgProto.MicroMsgResponseNew" /* cnb.z(-131649337555754L)  */, cntVar, 8);
        cucVar.x("ret" /* "ret" /* "ret" /* cnb.z(-131812546313002L)  */, false);
        cucVar.y(new aoz(1, 6));
        cucVar.x("toUserName" /* "toUserName" /* "toUserName" /* cnb.z(-131829726182186L)  */, false);
        cucVar.y(new aoz(2, 6));
        cucVar.x("msgId" /* "msgId" /* "msgId" /* cnb.z(-131799661411114L)  */, false);
        cucVar.y(new aoz(3, 6));
        cucVar.x("clientMsgId" /* "clientMsgId" /* "clientMsgId" /* cnb.z(-131756711738154L)  */, false);
        cucVar.y(new aoz(4, 6));
        cucVar.x("createTime" /* "createTime" /* "createTime" /* cnb.z(-131670812392234L)  */, false);
        cucVar.y(new aoz(5, 6));
        cucVar.x("serverTime" /* "serverTime" /* "serverTime" /* cnb.z(-131108171676458L)  */, false);
        cucVar.y(new aoz(6, 6));
        cucVar.x("type" /* "type" /* "type" /* cnb.z(-131078106905386L)  */, false);
        cucVar.y(new aoz(7, 6));
        cucVar.x("svrId" /* "svrId" /* "svrId" /* cnb.z(-131039452199722L)  */, false);
