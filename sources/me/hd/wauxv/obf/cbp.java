...
public abstract class cbp {
    ...
    public static bae b(lb lbVar, cbh cbhVar, cbg cbgVar) {
        return o(o(o(o(o(o(o(o(o(o(lbVar, cbgVar, "name", cbhVar.ab, new fq(23)), cbgVar, "nameCondition", cbhVar.ac, new fq(24)), cbgVar, "modifiers", cbhVar.ad, new fq(26)), cbgVar, "modifiersNot", cbhVar.ae, new fq(27)), cbgVar, "modifiersCondition", null, new fq(28)), cbgVar, "isSynthetic", null, new fq(29)), cbgVar, "isSyntheticNot", null, new cbk(0)), cbgVar, "annotations", cbhVar.af, new cbi(cbgVar, 15)), cbgVar, "annotationsNot", cbhVar.ag, new cbi(cbgVar, 16)), cbgVar, "genericString", null, new cbk(1));
    }
    ...
    public static boolean e(Collection collection, List list, cbg cbgVar) {
        ...
        if (collection.size() == list.size()) {
            ...
            for (Object obj : arrayList) {
                ...
                if (bzo.f(cls2, clsBf != null ? clsBf : eoz.class) || bzo.f(cls3, cls2)) {
                    arrayList2.add(obj);
                }
                i = i2;
            }
    ...
    public static bae f(bae baeVar, axd axdVar, cbg cbgVar) {
        return o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(o(baeVar, cbgVar, "parameters", axdVar.b, new cbi(cbgVar, 1)), cbgVar, "parametersNot", axdVar.c, new cbi(cbgVar, 7)), cbgVar, "parametersCondition", axdVar.d, new fq(16)), cbgVar, "parameterCount", axdVar.g, new fq(18)), cbgVar, "parameterCountCondition", null, new fq(19)), cbgVar, "typeParameters", axdVar.e, new fq(20)), cbgVar, "typeParametersNot", axdVar.f, new fq(21)), cbgVar, "exceptionTypes", axdVar.h, new cbi(cbgVar, 13)), cbgVar, "exceptionTypesNot", axdVar.i, new cbi(cbgVar, 14)), cbgVar, "genericExceptionTypes", axdVar.j, new fq(22)), cbgVar, "genericExceptionTypesNot", axdVar.k, new fq(10)), cbgVar, "genericParameters", axdVar.l, new fq(11)), cbgVar, "genericParametersNot", axdVar.m, new fq(12)), cbgVar, "isVarArgs", null, new fq(13)), cbgVar, "isVarArgsNot", null, new fq(14)), cbgVar, "parameterAnnotations", axdVar.n, new cbi(cbgVar, 2)), cbgVar, "parameterAnnotationsNot", axdVar.o, new cbi(cbgVar, 3)), cbgVar, "annotatedReturnType", axdVar.p, new cbi(cbgVar, 4)), cbgVar, "annotatedReturnTypeNot", axdVar.q, new cbi(cbgVar, 5)), cbgVar, "annotatedReceiverType", axdVar.r, new cbi(cbgVar, 6)), cbgVar, "annotatedReceiverTypeNot", axdVar.s, new cbi(cbgVar, 8)), cbgVar, "annotatedParameterTypes", axdVar.t, new cbi(cbgVar, 9)), cbgVar, "annotatedParameterTypesNot", axdVar.u, new cbi(cbgVar, 10)), cbgVar, "annotatedExceptionTypes", axdVar.v, new cbi(cbgVar, 11)), cbgVar, "annotatedExceptionTypesNot", axdVar.w, new cbi(cbgVar, 12));
    }
    ...
    public static List q(cbh cbhVar, cbg cbgVar, Class cls, bgf bgfVar) {
        Class cls2;
        List listQ = avd.a;
        if (cls != null) {
            cls2 = Object.class;
    ...
    public static final String s(cbg cbgVar, cbh cbhVar, String str) {
        ...
        try {
            ...
            for (Map.Entry entry : mapX.entrySet()) {
                ...
                if (value != null) {
                    strB = value instanceof bgp ? "(Runtime Condition)" : ((value instanceof Collection) && ((Collection) value).isEmpty()) ? null : eoz.b(value);
                }
                String strBo = strB != null ? dnr.bo(strB.toString(), " (Kotlin reflection is not available)", "") : null;
                csm csmVar = strBo != null ? new csm(str3, strBo) : null;
                if (csmVar != null) {
            ...
            if (arrayList.isEmpty()) {
                ...
                int iC = c((String) ((csm) it.next()).a);
                while (it.hasNext()) {
                    int iC2 = c((String) ((csm) it.next()).a);
                    if (iC < iC2) {
                        iC = iC2;
                    }
                }
                ...
                int iC3 = c((String) ((csm) it2.next()).b);
                while (it2.hasNext()) {
                    int iC4 = c((String) ((csm) it2.next()).b);
                    if (iC3 < iC4) {
                        iC3 = iC4;
                    }
                }
                ...
                int i2 = iC + i + 3;
                strConcat = aaz.k(aba.ag("+-" + dnr.bm(i2, "-") + "-+", "| " + d(i2, strBo2) + " |", str4, aaz.k(arrayList, "\n", null, null, new cbl(iC, i, 0), 30), str4), "\n", null, null, null, 62);
            }
        } catch (Throwable th) {
            bhu.x(th);
            strConcat = dnr.bo(cls.toString(), " (Kotlin reflection is not available)", "").concat("\nFailed to build condition table.");
        }
        return "No " + str + " found matching the condition for current class" + str2 + ".\n" + strConcat + "\nSuggestion: " + (!cbgVar.d ? "Members in superclass are not reflected in the current class, you can try adding superclass() in your condition and try again. " : "Check if the conditions are correct and valid, and try again. ");
    }
    ...
    public static Class t(Object obj, cbg cbgVar, String str) {
        ...
        if (obj instanceof Class) {
            ...
            Class cls2 = cbgVar.a;
            if (cbfVar == cbf.a) {
                clsF = zf.b(cls2.getClassLoader(), (String) obj);
            } else {
                clsF = zf.f((String) obj, 2, cls2.getClassLoader());
                if (clsF == null) {
                    clsF = Object.class;
