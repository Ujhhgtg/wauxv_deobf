...
public final class ic extends ho implements cbu, LayoutInflater.Factory2 {
    ...
    public ic(Context context, Window window, he heVar, Object obj) {
        hb hbVar = null;
        this.bf = -100;
        this.x = context;
        this.aa = heVar;
    ...
    */
    ...
    public final void cf() {
        ...
        contentFrameLayout.setAttachListener(new hq(this, i2));
        this.an = viewGroup;
        Object obj = this.w;
                ...
                if (eutVar != null) {
                    ...
                    if (!ektVar.g) {
                        ...
                        if ((ektVar.b & 8) != 0) {
                            ...
                            if (ektVar.g) {
                                eqz.t(toolbar.getRootView(), title);
                            }
                        }
                    }
                } else {
    ...
    public final hz ch(Context context) {
        if (this.bj == null) {
            if (jx.c == null) {
                ...
                jx.c = new jx(applicationContext, (LocationManager) applicationContext.getSystemService("location"));
            }
            this.bj = new hx(this, jx.c);
        }
        return this.bj;
    }
        ...
        if (view2 != null) {
            ...
            if (Build.VERSION.SDK_INT <= 28) {
                ...
                if (typedArrayObtainStyledAttributes5.hasValue(0)) {
                    eqz.t(view2, typedArrayObtainStyledAttributes5.getString(0));
                }
