...
public final class ddi extends Drawable {
    public float a;
    ...
    public ddi(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void m(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(ddj.b(this.e, this.a, this.g)), (int) Math.ceil(ddj.c(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
    ...
    public final void setTintList(ColorStateList colorStateList) {
        ...
        this.i = l(colorStateList, this.k);
        invalidateSelf();
    }
