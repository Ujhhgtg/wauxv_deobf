...
public final class gh extends doo implements bob {
    public static final gh a = new gh(cnb.z(-545009875024682L));
    public static final String b = cnb.z(-544674867575594L);
    public static final String c = cnb.z(-544692047444778L);
    public static final String d = cnb.z(-544657687706410L);
    ...
    public final void m(String str, ContentValues contentValues) {
        if (z()) {
            byte[] bArrV = null;
            if (str.equals(cnb.z(-544881026005802L))) {
                if (aaz.b(aba.ag(Integer.valueOf(ewj.a.h), Integer.valueOf(ewj.b.h), Integer.valueOf(ewj.c.h), Integer.valueOf(ewj.d.h), Integer.valueOf(ewj.f.h)), contentValues.get(cnb.z(-544846666267434L))) && bzo.f(contentValues.get(cnb.z(-544876731038506L)), 0)) {
                    byte[] bArr = (byte[]) contentValues.get(cnb.z(-545327702604586L));
                    contentValues.remove(cnb.z(-545293342866218L));
                    String strZ = cnb.z(-545280457964330L);
                    String strO = gg.a.o();
                    if (bArr != null) {
            ...
            if (str.equals(cnb.z(-545246098225962L)) && !bzo.f(contentValues.get(cnb.z(-545216033454890L)), 1) && bzo.f(contentValues.get(cnb.z(-545177378749226L)), 1)) {
                byte[] bArr2 = (byte[]) contentValues.get(cnb.z(-545091479403306L));
                contentValues.remove(cnb.z(-544520248752938L));
                String strZ2 = cnb.z(-544434349407018L);
                String strO2 = gg.a.o();
                if (bArr2 != null) {
