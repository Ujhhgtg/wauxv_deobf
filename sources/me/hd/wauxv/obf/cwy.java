...
public final class cwy extends doo implements bnn {
    ...
    public final List j() {
        return !z() ? avd.a : dqc.bf(new bly(R.id.MenuItem_Home_QuickKill, "快捷终止" /* cnb.z(-513201347230506L) */, R.drawable.ic_menu_kill_24dp, new cfh(20)));
    }
