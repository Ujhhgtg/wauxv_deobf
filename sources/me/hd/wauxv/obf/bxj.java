...
public final class bxj extends doo implements bng {
    ...
    static {
        cwb cwbVar = new cwb(bxj.class, "RedirectUIClass" /* cnb.z(-493818159823658L) */, "getRedirectUIClass()Ljava/lang/Class;" /* cnb.z(-493749440346922L) */);
        dal.a.getClass();
        b = new btc[]{cwbVar};
        a = new bxj("LocationHook" /* cnb.z(-496816046996266L) */);
        i = zf.h("com.tencent.mm.plugin.location.ui.RedirectUI" /* cnb.z(-494118807534378L) */, new amd(3), 2);
