        ...
        if (z()) {
            ...
            if (className != null) {
                ...
                if (iHashCode != -1765744774) {
                    if (iHashCode != 1306075868 || !className.equals("com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyPrepareUI" /* cnb.z(-537102840232746L) */)) {
                        return;
                    }
                } else if (!className.equals("com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyNewPrepareUI" /* cnb.z(-536862322064170L) */)) {
                    return;
                }
