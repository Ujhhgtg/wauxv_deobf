            ...
            case 1:
                ...
                if (compoundButton.isPressed()) {
                    if (!z) {
                        ...
                        dnc.sendToast(null, 3, yg.concatVar2AndDecryptedVar3ToVar1(sb, ctxVar.f, -60790967106346L));
                    } else {
                        ctxVar.q(true);
                    }
                    break;
                ...
                if (compoundButton.isPressed()) {
                    if (!z) {
                        ...
                        if (!cuk.e(ctxVar2)) {
                            ...
                            dnc.sendToast(null, 3, yg.concatVar2AndDecryptedVar3ToVar1(sb2, ctxVar2.f, -388488381856554L));
                        } else {
                            ctxVar2.q(true);
                        }
                    }
