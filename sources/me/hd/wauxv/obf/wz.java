...
public final class wz {
    ...
    public final boolean equals(Object obj) {
        ...
        wz wzVar = (wz) obj;
        return this.iconId == wzVar.iconId && nullSafeIsEqual(this.b, wzVar.b) && nullSafeIsEqual(this.c, wzVar.c);
    }

    public final int hashCode() {
        return this.c.hashCode() + bjs.e(this.b, Integer.hashCode(this.iconId) * 31, 31);
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("MenuBean(iconId=" /* "MenuBean(iconId=" /* "MenuBean(iconId=" /* cnb.z(-549291957418794L)  */);
        StaticHelpers6.ac(sb, this.iconId, -549218942974762L);
