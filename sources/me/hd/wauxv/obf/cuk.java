...
public abstract class cuk {
    ...
    public static List d() {
        dov dovVar = ctf.a;
        File[] fileArrListFiles = new File(ctf.c(cnb.z(-47055661693738L))).listFiles(new cui());
        if (fileArrListFiles == null) {
            return avd.a;
        }
        ArrayList arrayList = new ArrayList();
        for (File file : fileArrListFiles) {
            File file2 = new File(file, cnb.z(-390270793284394L));
    ...
    public static boolean e(ctx ctxVar) throws IOException {
        ...
        try {
            ctxVar.o();
            ctxVar.n(cnb.z(-402056183544618L), new Object[0]);
            objX = Boolean.TRUE;
        } catch (Throwable th) {
            objX = bhu.x(th);
        }
        ...
        if (thB != null) {
            ...
            ewq.e(cnb.z(-400741923552042L) + ctxVar.f + cnb.z(-400707563813674L) + thB.getMessage(), null, 14);
            bmu bmuVar = ctxVar.m;
            StringBuilder sb = new StringBuilder();
            sb.append(cnb.z(-400651729238826L));
    ...
    public static void g(ctx ctxVar) {
        ...
        String str = ctxVar.f;
        try {
            ctxVar.n(cnb.z(-402026118773546L), new Object[0]);
        ...
        if (thB != null) {
            ArrayList arrayList = ewq.a;
            ewq.e(cnb.z(-400574419827498L) + str + cnb.z(-400540060089130L) + thB.getMessage(), null, 14);
            bmu bmuVar = ctxVar.m;
            StringBuilder sb = new StringBuilder();
            sb.append(cnb.z(-402124903021354L));
            sb.append(thB.getMessage());
            bmuVar.p(sb.toString());
            objX = Boolean.FALSE;
        }
