...
public final class blh extends SwitchHook {
    ...
    public final void initOnce() {
        int i = 0;
        MethodHookWrapper methodHookWrapperVar = (MethodHookWrapper) dkz.n(new Object[] { dal.b(View.class) }, 1, yg.s(-486417931172650L).t());
        exg exgVar = exg.a;
        blh blhVar = a;
        aki akiVarAd = blhVar.ad(methodHookWrapperVar, exgVar);
