...
public final class atr {
    ...
    static {
        atr atrVar = new atr(cnb.z(-506612867398442L), 0, 0, cnb.z(-506630047267626L));
        a = atrVar;
        atr atrVar2 = new atr(cnb.z(-506020161911594L), 1, 1, cnb.z(-506037341780778L));
        b = atrVar2;
        atr atrVar3 = new atr(cnb.z(-506045931715370L), 2, 2, cnb.z(-506002982042410L));
        c = atrVar3;
        atr atrVar4 = new atr(cnb.z(-506011571977002L), 3, 3, cnb.z(-505972917271338L));
        d = atrVar4;
        atr atrVar5 = new atr(cnb.z(-505981507205930L), 4, 4, cnb.z(-505925672631082L));
        e = atrVar5;
        atr atrVar6 = new atr(cnb.z(-505934262565674L), 5, 5, cnb.z(-505882722958122L));
        f = atrVar6;
