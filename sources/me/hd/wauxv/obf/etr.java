...
public final class etr extends SwitchHook implements IDexFind {
    public static final etr a = new etr("VoiceLengthHook" /* "VoiceLengthHook" /* "VoiceLengthHook" /* cnb.z(-500123171814186L)  */);
    public static final String b = "辅助" /* "辅助" /* "辅助" /* cnb.z(-499264178354986L)  */;
    public static final String c = "语音时长" /* "语音时长" /* "语音时长" /* cnb.z(-499268473322282L)  */;
    public static final String i = "可自定义修改发送的语音消息显示时长" /* "可自定义修改发送的语音消息显示时长" /* "可自定义修改发送的语音消息显示时长" /* cnb.z(-499229818616618L)  */;
