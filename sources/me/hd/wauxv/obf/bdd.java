...
public final class bdd extends bdh {
    ...
    public bdd(SomeFragmentManager someFragmentManagerVar) {
    ...
    public final void b() {
        ...
        ((deo) someFragmentManagerVar.ck.b).i();
        aye.r(someFragmentManagerVar);
        Bundle bundle = someFragmentManagerVar.at;
        someFragmentManagerVar.ck.aa(bundle != null ? bundle.getBundle("registryState") : null);
    }
}
