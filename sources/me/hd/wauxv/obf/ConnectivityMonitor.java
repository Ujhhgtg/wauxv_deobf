...
public final class ConnectivityMonitor implements bic {
    public static volatile ConnectivityMonitor a;
    public final /* synthetic */ int b;
    public boolean c;
    public Object d;
    public AbstractCollection e;

    public ConnectivityMonitor(int i) {
        this.b = i;
        switch (i) {
            case 3:
                break;
    ...
    public static ConnectivityMonitor f(Context context) {
        if (a == null) {
            synchronized (ConnectivityMonitor.class) {
                try {
                    if (a == null) {
                        a = new ConnectivityMonitor(context.getApplicationContext());
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public Object get() {
        ...
        HugeSyntheticPileOfHelpers.beginTrace("Glide registry");
        this.c = true;
        try {
    ...
    public ConnectivityMonitor(com.bumptech.glide.a aVar, ArrayList arrayList, cna cnaVar) {
        this.b = 1;
        this.d = aVar;
        this.e = arrayList;
    }
