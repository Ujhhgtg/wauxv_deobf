    ...
    public final Object invoke(Object obj) throws IllegalAccessException {
        ...
        switch (i) {
            ...
            case 3:
                bah bahVar = (bah) obj;
                cdj cdjVar = new cdj();
                cdjVar.t(cnb.z(-517732537727786L), cnb.z(-517015278189354L));
                bahVar.getClass();
                bahVar.d = cdjVar;
                return ensVar;
            case 4:
                bag bagVar = (bag) obj;
                String[] strArr = {cnb.z(-69539815488298L)};
                bagVar.getClass();
                ...
                fj fjVar = new fj();
                cdj cdjVar2 = new cdj();
                cdjVar2.s(cnb.z(-69363721829162L));
                fjVar.f(cdjVar2);
                zbVar.f = fjVar;
                bagVar.b = zbVar;
                return ensVar;
            case 5:
                bah bahVar2 = (bah) obj;
                cdj cdjVar3 = new cdj();
                cdjVar3.s(cnb.z(-69282117450538L));
                bahVar2.getClass();
                bahVar2.d = cdjVar3;
                return ensVar;
            case 6:
                ...
                azgVarR.ab = cnb.z(-70201240451882L);
                ...
                for (bnq bnqVar : cey.b) {
                    try {
                        ...
                        sb.append(cnb.z(-70209830386474L));
                        ewq.e(yg.n(sb, bnqVar instanceof doo ? ((doo) bnqVar).f() : cnb.z(-70162585746218L), -70123931040554L), e, 12);
                    }
                }
                return ensVar;
            case 7:
                ...
                azgVarR2.ab = cnb.z(-69831873264426L);
                ...
                for (bnq bnqVar2 : cey.b) {
                    try {
                        ...
                        sb2.append(cnb.z(-69840463199018L));
                        ewq.e(yg.n(sb2, bnqVar2 instanceof doo ? ((doo) bnqVar2).f() : cnb.z(-70274254895914L), -70235600190250L), e2, 12);
                    }
                }
                return ensVar;
            case 8:
            ...
            case 12:
                bag bagVar2 = (bag) obj;
                String[] strArr2 = {cnb.z(-69767448754986L)};
                bagVar2.getClass();
                ...
                fj fjVar2 = new fj();
                cdj cdjVar4 = new cdj();
                cdjVar4.s(cnb.z(-69642894703402L));
                fjVar2.f(cdjVar4);
                zbVar3.f = fjVar2;
                bagVar2.b = zbVar3;
                return ensVar;
            case 13:
                bah bahVar3 = (bah) obj;
                cdj cdjVar5 = new cdj();
                cdjVar5.s(cnb.z(-66786741451562L));
                bahVar3.getClass();
                bahVar3.d = cdjVar5;
                return ensVar;
            case 14:
                                                    ...
                                                    if (((TextInputLayout) cnd.aq(viewK, R.id.moduleDialogInputMsgBgBubbleRightBubble)) != null) {
                                                        ...
                                                        if (((TextInputLayout) cnd.aq(viewK, R.id.moduleDialogInputMsgBgBubbleRightDarkBubbleColor)) != null) {
                                                            ...
                                                            if (((TextInputLayout) cnd.aq(viewK, R.id.moduleDialogInputMsgBgBubbleRightLightBubbleColor)) != null) {
                                                                ...
                                                                cfm.a.getClass();
                                                                egVar.d = cfm.m;
                                                                bzyVar.t(cnb.z(-451409652742954L), new amw(new bp(ceoVar, 28), 0));
                                                                bzyVar.s(cnb.z(-451413947710250L), new amw(new cfh(i9), 2));
                ...
                throw new NullPointerException(cnb.z(-661940359658282L).concat(viewK.getResources().getResourceName(i10)));
            case 15:
                View view3 = (View) obj;
                                                                    ...
                                                                    if (((TextInputLayout) cnd.aq(viewK2, R.id.moduleDialogInputMsgBgColorRightDarkStrokeColor)) != null) {
                                                                        ...
                                                                        if (((TextInputLayout) cnd.aq(viewK2, R.id.moduleDialogInputMsgBgColorRightLightBgColor)) != null) {
                                                                            ...
                                                                            if (((TextInputLayout) cnd.aq(viewK2, R.id.moduleDialogInputMsgBgColorRightLightStrokeColor)) != null) {
                                                                                ...
                                                                                cfv.a.getClass();
                                                                                egVar2.d = cfv.c;
                                                                                bzyVar2.t(cnb.z(-449592881576746L), new amw(new bp(cegVar, 29), 0));
                                                                                bzyVar2.s(cnb.z(-449545636936490L), new amw(new cfh(i4), 2));
                ...
                throw new NullPointerException(cnb.z(-662352676518698L).concat(viewK2.getResources().getResourceName(i11)));
            case 16:
                View view4 = (View) obj;
                        ...
                        if (textInputEditText14 != null) {
                            ...
                            if (((TextInputLayout) cnd.aq(viewK3, R.id.moduleDialogInputMsgFormatTextFormat)) != null) {
                                ...
                                if (((TextInputLayout) cnd.aq(viewK3, R.id.moduleDialogInputMsgFormatTimeFormat)) != null) {
                                    ...
                                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(cnb.z(-469285306628906L));
                                    ...
                                    cgb.a.getClass();
                                    egVar3.d = cgb.i;
                                    bzyVar3.t(cnb.z(-468666831338282L), new amw(new cfx(cemVar, 0), 0));
                                    bzyVar3.s(cnb.z(-468602406828842L), new amw(new cfh(i2), 2));
                ...
                throw new NullPointerException(cnb.z(-662215237565226L).concat(viewK3.getResources().getResourceName(i12)));
            case 17:
                amm ammVar3 = (amm) obj;
            ...
            case 18:
                bag bagVar3 = (bag) obj;
                String[] strArr3 = {cnb.z(-468507917548330L)};
                bagVar3.getClass();
                bagVar3.a = la.ab(strArr3);
                zb zbVar5 = new zb();
                zbVar5.k(cnb.z(-468881579703082L), cnb.z(-468769910553386L));
                bagVar3.b = zbVar5;
                return ensVar;
            case 19:
                bah bahVar4 = (bah) obj;
            ...
            case 21:
                bag bagVar4 = (bag) obj;
                String[] strArr4 = {cnb.z(-75037373627178L)};
                bagVar4.getClass();
                bagVar4.a = la.ab(strArr4);
                zb zbVar6 = new zb();
                zbVar6.k(cnb.z(-74938589379370L), cnb.z(-74865574935338L));
                bagVar4.b = zbVar6;
                return ensVar;
            case 22:
                bmm bmmVar4 = (bmm) obj;
                for (bnr bnrVar : cgf.b) {
                    try {
                        ...
                        sb3.append(cnb.z(-66645007530794L));
                        ewq.e(yg.n(sb3, bnrVar instanceof doo ? ((doo) bnrVar).f() : cnb.z(-66563403152170L), -66524748446506L), e3, 12);
                    }
                }
                return ensVar;
            case 23:
                                                                                        ...
                                                                                        if (((TextInputLayout) cnd.aq(viewK4, R.id.moduleDialogInputMsgInfoRightMargin)) != null) {
                                                                                            ...
                                                                                            if (((TextInputLayout) cnd.aq(viewK4, R.id.moduleDialogInputMsgInfoTextFormat)) != null) {
                                                                                                ...
                                                                                                if (((TextInputLayout) cnd.aq(viewK4, R.id.moduleDialogInputMsgInfoTimeFormat)) != null) {
                                                                                                    ...
                                                                                                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(cnb.z(-467511485135658L));
                                                                                                    ...
                                                                                                    cgr.c.getClass();
                                                                                                    egVar4.d = cgr.j;
                                                                                                    bzyVar4.t(cnb.z(-467442765658922L), new amw(new cfx(cenVar, i6), 0));
                                                                                                    bzyVar4.s(cnb.z(-467464240495402L), new amw(new cfh(6), 2));
                ...
                throw new NullPointerException(cnb.z(-663727066053418L).concat(viewK4.getResources().getResourceName(i13)));
            case 24:
                bmm bmmVar5 = (bmm) obj;
                bmmVar5.getClass();
                try {
                ...
                for (bns bnsVar : cgt.b) {
                    try {
                        ...
                        sb4.append(cnb.z(-66932770339626L));
                        ewq.e(yg.n(sb4, bnsVar instanceof doo ? ((doo) bnsVar).f() : cnb.z(-66838281059114L), -66799626353450L), e4, 12);
                    }
                }
                return ensVar;
            case 25:
            ...
            case 26:
                bah bahVar5 = (bah) obj;
                String[] strArr5 = {cnb.z(-66215510801194L)};
                bahVar5.getClass();
                bahVar5.a = la.ab(strArr5);
                cdj cdjVar7 = new cdj();
                cdjVar7.t(cnb.z(-66116726553386L), cnb.z(-66013647338282L));
                bahVar5.d = cdjVar7;
                return ensVar;
            case 27:
                ((amm) obj).b = new cgu(1);
