...
public final class HomePopMenuApiHook extends ApiHookItem implements IDexFind {
    ...
    public final void initOnce() {
        ...
        hookManagerVarAb.hookAfter(new bep(27));
        ...
        hookManagerVarAb2.hookAfter(new bep(26));
    ...
    public final void dexFind(DexKitBridge dexKitBridge) {
        StaticHelpers7.resolveDexAndCache(HomePopMenuApi$MethodAddItem.INSTANCE, dexKitBridge, (obj) -> {
            ...
            bah4.searchedPackages = SomeStaticHelpers.arrayToList(new String[] { "com.tencent.mm.ui" });
