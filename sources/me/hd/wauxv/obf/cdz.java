...
public final /* synthetic */ class cdz extends bgr implements IInvokable {
    public static final cdz a = new cdz(1, dk.class, "inflate" /* "inflate" /* "inflate" /* "inflate" /* cnb.z(-387337330621226L)   */, "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityModuleBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityModuleBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityModuleBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityModuleBinding;" /* cnb.z(-388952238324522L)   */, 0);
