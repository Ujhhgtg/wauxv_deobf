...
public final class dyi {
    ...
    public final String toString() {
        ...
        sb.append("gt1Proto(docId=" /* "gt1Proto(docId=" /* "gt1Proto(docId=" /* "gt1Proto(docId=" /* cnb.z(-209100482804522L)   */);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.a, -209031763327786L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.b, -208975928752938L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.c, -208941569014570L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.d, -209396835547946L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.e, -209375360711466L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.f, -209267986529066L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.g, -209186382150442L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.h, -210809879788330L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.i, -210754045213482L);
        bjs.w(sb, this.j, -210685325736746L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.k, -210599426390826L);
        bjs.w(sb, this.l, -210582246521642L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.m, -211101937564458L);
        bjs.w(sb, this.n, -211037513055018L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.o, -210955908676394L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.p, -210895779134250L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.q, -210281598810922L);
        sb.append(this.r);
        sb.append(')');
        return sb.toString();
    }
