...
public final class cxb extends doo implements bnf {
    ...
    public final List a(ConversationBean conversationBean) {
        return (!z() || dnj.ab(conversationBean.getUsername(), "@" /* cnb.z(-527215825517354L) */, false) || dnr.bp(conversationBean.getUsername(), "gh_" /* cnb.z(-527155695975210L) */, false)) ? avd.a : dqc.bf(new agf(R.id.MenuItem_Conversation_QuickPullGroup, "快捷拉群" /* cnb.z(-527172875844394L) */, new cvc(5)));
    }
