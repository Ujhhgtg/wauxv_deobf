...
public abstract class Delayed implements Runnable, Comparable, aox {
    ...
    public final void e() {
        synchronized (this) {
            try {
                ...
                SpecificEmojiMatcher specificEmojiMatcherVar = emc.t;
                ...
                this._heap = specificEmojiMatcherVar;
            } catch (Throwable th) {
                throw th;
            }
        }
