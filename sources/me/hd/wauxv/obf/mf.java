...
public final class mf extends doo implements boc {
    public static final mf a = new mf("AutoSelectOriginalPhotoHook" /* cnb.z(-443369473964842L) */);
        ...
        if (z()) {
            ...
            if (className != null) {
                ...
                if (iHashCode != 812972616) {
                    if (iHashCode != 1600608476 || !className.equals("com.tencent.mm.plugin.gallery.ui.ImagePreviewUI" /* cnb.z(-443214855142186L) */)) {
                        return;
                    }
                } else if (!className.equals("com.tencent.mm.plugin.gallery.ui.AlbumPreviewUI" /* cnb.z(-443558452525866L) */)) {
                    return;
                }
