...
public final class agp extends bws implements IDexFind {
    ...
    public static void c(agp agpVar, Object obj, String str) {
        ...
        Object objJ = ((MethodHookWrapper) StaticHelpers6.setParamsBasedOnVar1Var2AndResolveFirstMethod(new Object[] { declaringClass, zcVarB, dal.getKClassFromClass(cls), dal.getKClassFromClass(cls) }, 4, methodResolverVarT)).invoke(obj,
                str, false, true);
