...
public final class cha extends doo implements bnn {
    ...
    public final List j() {
        return !z() ? avd.a : aba.ag(new bly(R.id.MenuItem_Home_MsgListHide, "列表隐藏" /* cnb.z(-524656025008938L) */, R.drawable.ic_menu_hide_24dp, new cfh(7)), new bly(R.id.MenuItem_Home_MsgListShow, "列表显示" /* cnb.z(-524668909910826L) */, R.drawable.ic_menu_show_24dp, new cfh(8)));
    }
