...
public final class crm extends SwitchHook implements bnn {
    ...
    public static final AnotherHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg i = new AnotherHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg(0);
