...
public abstract class ViewCompat {
    ...
    public static esg getOrCreateAnimationHelper(View view) {
        if (a == null) {
            a = new WeakHashMap();
        }
    ...
    public static void notifyAccessibilityChange(View view, int i) {
    ...
    public static void q(View view, ax axVar, IHandlesSwipeDismiss bmVar) {
        ax axVar2 = new ax(null, axVar.m, null, bmVar, axVar.n);
        View.AccessibilityDelegate accessibilityDelegateJ = getAccessibilityDelegate(view);
        ...
        setAccessibilityDelegate(view, aqVar);
        p(view, axVar2.p());
        l(view).add(axVar2);
        notifyAccessibilityChange(view, 0);
    }
    ...
    public static void setAccessibilityDelegate(View view, AccessibilityDelegateCompat aqVar) {
        if (aqVar == null && (getAccessibilityDelegate(view) instanceof AccessibilityDelegateCompat$AccessibilityDelegateAdapter)) {
            aqVar = new AccessibilityDelegateCompat();
        }
        if (view.getImportantForAccessibility() == 0) {
            view.setImportantForAccessibility(1);
    ...
    public static void setAccessibilityPaneTitle(View view, CharSequence charSequence) {
        new eqm(R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28, 1).setAccessibilityProperty(view, charSequence);
        eqn eqnVar = f;
    ...
    public static void setWindowInsetsAnimation(View view, ua uaVar) {
