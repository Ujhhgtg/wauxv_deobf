    ...
    public final Object g(Object obj, Object obj2) throws IllegalAccessException, JSONException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        switch (i) {
            ...
            case 25:
                ...
                int i8 = ddmVarQ.a;
                int i9 = ddmVarQ.d;
                return codeEditor4.getText().x().o(i8, cnd.an(i7, ddmVarQ.e - i9) + i9);
            case 26:
                ...
                int i11 = ddmVarQ2.a;
                int i12 = ddmVarQ2.d;
                return codeEditor5.getText().x().o(i11, cnd.an(i10, ddmVarQ2.e - i12) + i12);
            case 27:
                ...
                int i14 = ddmVarQ3.a;
                int i15 = ddmVarQ3.d;
                return codeEditor6.getText().x().o(i14, cnd.an(i13, ddmVarQ3.e - i15) + i15);
            case 28:
                ...
                int i17 = ddmVarQ4.a;
                int i18 = ddmVarQ4.d;
                return codeEditor7.getText().x().o(i17, cnd.an(i16, ddmVarQ4.e - i18) + i18);
            default:
