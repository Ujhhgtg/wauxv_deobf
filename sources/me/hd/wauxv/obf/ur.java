...
public final class ur extends ApiHookItem {
    public static final ur a = new ur();
    public static final LinkedHashSet b = new LinkedHashSet();

    @Override // me.hd.wauxv.obf.SwitchHook
    public final void initOnce() {
        adt adtVarM = dqc.bh(ajn.tryGetClassByClassName("com.tencent.mm.pluginsdk.ui.chat.ChatFooter")).m();
        ...
        hookManagerVarAd.hookAfter(new SomeHugeSyntheticPileOfClosuresThatActsDifferentlyBasedOnConstructorArg(27));
