...
public abstract /* synthetic */ class dkz {
    ...
    public static Object m(cde cdeVar) {
        cdeVar.ah();
        return aaz.e(cdeVar.aj());
    }

    public static Object n(Object[] objArr, int i, cde cdeVar) {
        cdeVar.z(Arrays.copyOf(objArr, i));
        return aaz.e(cdeVar.aj());
    }
    ...
    public static String t(String str, MethodDescription methodDescription) {
        return str + methodDescription;
    }

    public static String u(String str, TypeDescription typeDescription) {
    ...
    public static String w(StringBuilder sb, ElementMatcher elementMatcher, String str) {
        sb.append(elementMatcher);
        sb.append(str);
        return sb.toString();
    }

    public static String x(TypeDescription typeDescription, String str) {
    ...
    public static StringBuilder z(String str, String str2, String str3) {
