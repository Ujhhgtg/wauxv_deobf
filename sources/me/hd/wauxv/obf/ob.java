...
public final class ob extends oc {
    ...
    public final String toString() {
        ...
        sb.append("Switch(title=" /* "Switch(title=" /* "Switch(title=" /* cnb.z(-388149079440170L)  */);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.a, -388621525842730L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.b, -388587166104362L);
        sb.append(this.c);
        sb.append(", onClick=" /* ", onClick=" /* ", onClick=" /* cnb.z(-388552806365994L)  */);
        sb.append(this.d);
        sb.append(')');
        return sb.toString();
    }
