...
public final /* synthetic */ class h implements IFunction0 {
    ...
    public final Object invoke() {
        ...
        switch (i) {
            ...
            case 3:
                ...
                if (r6 == 0) {
                    r6 = str;
                    return "未填写" /* "未填写" /* "未填写" /* cnb.z(-121259811666730L)  */;
                }
                r6 = str;
                return r6;
            case 4:
            ...
            case 5:
                ...
                by.a.u("#FFFFFFFF" /* "#FFFFFFFF" /* "#FFFFFFFF" /* cnb.z(-432829624220458L)  */);
                bx.a.u("#FF191919" /* "#FF191919" /* "#FF191919" /* cnb.z(-432735134939946L)  */);
                return kotlinUnitVar;
            case 6:
                return new ep(0);
            case 7:
            ...
            case 9:
                File file = new File(BottomTabCustomHook.b, "icon_chats.png" /* "icon_chats.png" /* "icon_chats.png" /* cnb.z(-437713002036010L)  */);
                if (file.exists()) {
            ...
            case 13:
                ...
                qi.a.u("发现" /* "发现" /* "发现" /* cnb.z(-437974995041066L)  */);
                ql.a.u("我的" /* "我的" /* "我的" /* cnb.z(-437979290008362L)  */);
                qm.a.p(true);
                qn.a.p(true);
                qk.a.p(false);
                qj.a.p(false);
            ...
            case 19:
                ...
                qt.a.u("#FF1E1E1E" /* "#FF1E1E1E" /* "#FF1E1E1E" /* cnb.z(-437356519750442L)  */);
                qq.a.u("#FF1E1E1E" /* "#FF1E1E1E" /* "#FF1E1E1E" /* cnb.z(-436780994132778L)  */);
                qu.a.u("#FF324B48" /* "#FF324B48" /* "#FF324B48" /* cnb.z(-436686504852266L)  */);
                qs.a.u("#FFF7F7F7" /* "#FFF7F7F7" /* "#FFF7F7F7" /* cnb.z(-436660735048490L)  */);
                return kotlinUnitVar;
            case 20:
                vc.a.r(48);
                vf.a.r(80);
                vb.a.u("#FFF7F7F7" /* "#FFF7F7F7" /* "#FFF7F7F7" /* cnb.z(-576418970860330L)  */);
                uw.a.u("#FFCCE8E3" /* "#FFCCE8E3" /* "#FFCCE8E3" /* cnb.z(-576324481579818L)  */);
                uz.a.u("#FF1E1E1E" /* "#FF1E1E1E" /* "#FF1E1E1E" /* cnb.z(-576298711776042L)  */);
                ve.a.u("#FF006A62" /* "#FF006A62" /* "#FF006A62" /* cnb.z(-576272941972266L)  */);
                va.a.u("#FF1E1E1E" /* "#FF1E1E1E" /* "#FF1E1E1E" /* cnb.z(-576247172168490L)  */);
                uv.a.u("#FF324B48" /* "#FF324B48" /* "#FF324B48" /* cnb.z(-576152682887978L)  */);
                uy.a.u("#FFF7F7F7" /* "#FFF7F7F7" /* "#FFF7F7F7" /* cnb.z(-576676668898090L)  */);
                vd.a.u("#FF81D5CB" /* "#FF81D5CB" /* "#FF81D5CB" /* cnb.z(-576650899094314L)  */);
                return kotlinUnitVar;
            case 21:
                vr.a.u("#FFEDEDED" /* "#FFEDEDED" /* "#FFEDEDED" /* cnb.z(-568408856853290L)  */);
                vk.a.u("#FF006A62" /* "#FF006A62" /* "#FF006A62" /* cnb.z(-568314367572778L)  */);
                vm.a.u("#FF161D1C" /* "#FF161D1C" /* "#FF161D1C" /* cnb.z(-568288597769002L)  */);
                vo.a.u("#FF006A62" /* "#FF006A62" /* "#FF006A62" /* cnb.z(-568262827965226L)  */);
                vq.a.u("#FF242424" /* "#FF242424" /* "#FF242424" /* cnb.z(-568237058161450L)  */);
                vj.a.u("#FF81D5CB" /* "#FF81D5CB" /* "#FF81D5CB" /* cnb.z(-567592813067050L)  */);
                vl.a.u("#FFDDE4E2" /* "#FFDDE4E2" /* "#FFDDE4E2" /* cnb.z(-567567043263274L)  */);
                vn.a.u("#FF81D5CB" /* "#FF81D5CB" /* "#FF81D5CB" /* cnb.z(-567541273459498L)  */);
                vp.a.p(false);
                return kotlinUnitVar;
            case 22:
                vz.a.u("今日已发${totalMsg}条" /* "今日已发${totalMsg}条" /* "今日已发${totalMsg}条" /* cnb.z(-422908249766698L)  */);
                vy.a.p(true);
                return kotlinUnitVar;
            case 23:
                return xf.l;
