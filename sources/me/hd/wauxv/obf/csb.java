...
public class csb {
    ...
    public static final aki ab(csb csbVar, List list) {
        csbVar.getClass();
        ...
        erpVar.v = th;
        aki akiVar = new aki(new but(csbVar, erpVar), exg.a, exi.b);
        if (!list.isEmpty()) {
    ...
    public final aki ad(cbq cbqVar, exg exgVar) {
        ...
        erp erpVar = new erp(29, false);
        erpVar.v = th;
        aki akiVar = new aki(new but(this, erpVar), exgVar, exi.c);
        if (!listBf.isEmpty()) {
            LinkedHashSet linkedHashSet = (LinkedHashSet) akiVar.i;
            linkedHashSet.clear();
