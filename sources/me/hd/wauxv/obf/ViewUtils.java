...
public final class ViewUtils implements cqk, afi, ccl {
    public final /* synthetic */ int a;
    public final /* synthetic */ AppCompatDelegate b;

    public /* synthetic */ ViewUtils(AppCompatDelegate appCompatDelegateVar, int i) {
        this.a = i;
    ...
    public evr _ae(View view, evr evrVar) {
        ...
        if (actionBarContextView == null
            ...
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) appCompatDelegateVar.ai.getLayoutParams();
            if (appCompatDelegateVar.ai.isShown()) {
                if (appCompatDelegateVar.bp == null) {
                    appCompatDelegateVar.bp = new Rect();
                    appCompatDelegateVar.bq = new Rect();
                }
                Rect rect = appCompatDelegateVar.bp;
                Rect rect2 = appCompatDelegateVar.bq;
                ...
                int i3 = rect.left;
                int i4 = rect.right;
                ViewGroup viewGroup2 = appCompatDelegateVar.an;
                ...
                if (i2 <= 0 || appCompatDelegateVar.ap != null) {
                    View view2 = appCompatDelegateVar.ap;
                    if (view2 != null) {
                        ...
                        if (i5 != i6 || marginLayoutParams2.leftMargin != iF || marginLayoutParams2.rightMargin != iG) {
                            ...
                            appCompatDelegateVar.ap.setLayoutParams(marginLayoutParams2);
                        }
                    }
                } else {
                    View view3 = new View(context);
                    appCompatDelegateVar.ap = view3;
                    ...
                    appCompatDelegateVar.an.addView(appCompatDelegateVar.ap, -1, layoutParams);
                }
                View view4 = appCompatDelegateVar.ap;
                z = view4 != null;
                if (z && view4.getVisibility() != 0) {
                    View view5 = appCompatDelegateVar.ap;
            ...
            if (z) {
                appCompatDelegateVar.ai.setLayoutParams(marginLayoutParams);
            }
        }
        View view6 = appCompatDelegateVar.ap;
        if (view6 != null) {
    ...
    public void c(cbw cbwVar, boolean z) {
        ...
        switch (this.a) {
            ...
            default:
                ...
                AppCompatDelegate appCompatDelegateVar = this.b;
                ib[] ibVarArr = appCompatDelegateVar.ay;
                ...
                if (ibVar != null) {
                    if (!z2) {
                        appCompatDelegateVar.cc(ibVar, z);
                    } else {
                        appCompatDelegateVar.ca(ibVar.a, ibVar, cbwVarAj);
                        appCompatDelegateVar.cc(ibVar, true);
                    }
                }
                break;
        }
    ...
    public boolean d(cbw cbwVar) {
        ...
        switch (this.a) {
            ...
            default:
                if (cbwVar == cbwVar.aj()) {
                    AppCompatDelegate appCompatDelegateVar = this.b;
                    if (appCompatDelegateVar.as && (callback = appCompatDelegateVar.y.getCallback()) != null && !appCompatDelegateVar.bd) {
