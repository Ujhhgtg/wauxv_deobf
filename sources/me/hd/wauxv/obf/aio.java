...
public final class aio extends doo {
    public static final aio a = new aio(cnb.z(-429612693715754L));
    public static final String b = cnb.z(-429045758032682L);
    public static final String c = cnb.z(-428998513392426L);
    public static final String d = cnb.z(-428955563719466L);
