    ...
    public final Object invoke(Object obj) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        switch (i) {
            case 0:
                ...
                String strZ = "default" /* cnb.z(-556073710779178L) */;
                String strZ2 = "默认" /* cnb.z(-556039351040810L) */;
                djs djsVar = new djs();
                ...
                for (Object obj2 : list) {
                    ...
                    azgVarR.ab = "field_labelID" /* cnb.z(-556387243391786L) */;
                ...
                while (true) {
                    ...
                    if (bvxVar.hasNext()) {
                        ...
                        if (!str.equals("default" /* cnb.z(-558470302530346L) */)) {
                        ...
                        while (true) {
                            ...
                            if (!bvxVar2.hasNext()) {
                                ...
                                builder.setTitle("请选择过滤标签" /* cnb.z(-558388698151722L) */);
                                ...
                                builder.setPositiveButton("确定" /* cnb.z(-558354338413354L) */, new DialogInterface.OnClickListener() { // from class: me.hd.wauxv.obf.djr
                                ...
                                builder.setNegativeButton("取消" /* cnb.z(-558358633380650L) */, (DialogInterface.OnClickListener) null);
                                builder.show();
                                return Boolean.TRUE;
                            }
