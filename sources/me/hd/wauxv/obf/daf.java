...
public final class daf extends doo implements bnc {
    ...
    public final void i(View view, Object obj, Object obj2, MsgInfoBean msgInfoBean) {
        if (z() && msgInfoBean.isGroupChat() && msgInfoBean.isRedBag()) {
            Object byPath = dnc.e(msgInfoBean.getContent()).getByPath("msg.appmsg.wcpayinfo" /* cnb.z(-538537359309610L) */);
            bzo.o(byPath, "null cannot be cast to non-null type com.alibaba.fastjson2.JSONObject" /* cnb.z(-537931768920874L) */);
            String queryParameter = Uri.parse(((JSONObject) byPath).getString("nativeurl" /* cnb.z(-538163697154858L) */)).getQueryParameter("total_num" /* cnb.z(-538137927351082L) */);
            if (queryParameter == null) {
                return;
            }
            int[] iArr = msgInfoBean.isSend() ? new int[]{4, 0, 0, 1, 2, 0} : new int[]{4, 1, 0, 1, 1, 2, 0};
            TextView textView = (TextView) erb.b(view, "RedPacket.Subtitle" /* cnb.z(-538043438070570L) */, Arrays.copyOf(iArr, iArr.length));
            if (textView == null) {
                return;
            }
