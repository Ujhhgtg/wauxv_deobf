...
public final /* synthetic */ class brz extends bgr implements Function2 {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (!dfxVar2.m(iIntValue2)) {
                    ...
                    if (nullSafeIsEqual(emcVarH, dnt.c) || nullSafeIsEqual(emcVarH, dnt.b)) {
                        cwlVar.an = false;
                    } else if (dfxVarL.f()) {
                        cwlVar.an = true;
                    }
