...
public final class ge extends doo {
    public static final ge a = new ge(cnb.z(-543888888560426L));
    public static final String b = cnb.z(-544198126205738L);
    public static final String c = cnb.z(-544215306074922L);
    public static final String d = cnb.z(-544180946336554L);
