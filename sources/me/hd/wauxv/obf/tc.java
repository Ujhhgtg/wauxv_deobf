...
public class tc extends aot implements afw, ahr {
    ...
    public static void i(tc tcVar, Object obj, int i) throws aoq {
        ...
        while (true) {
            ...
            Object obj2 = atomicReferenceFieldUpdater.get(tcVar);
            ...
            do {
                if (atomicReferenceFieldUpdater.compareAndSet(tcVar, obj2, abpVar)) {
                    if (!tcVar.v()) {
            ...
            } while (atomicReferenceFieldUpdater.get(tcVar) == obj2);
        }
    }
                ...
                if (!z && (afwVar instanceof aor)) {
                    ...
                    if (z2 == (i4 == 1 || i4 == 2)) {
                        ...
                        try {
                            ...
                            throw new aoq(th2, ahjVar, ahhVar);
                        }
                    }
                }
        ...
        if (aorVar != null) {
            ...
            loop0: while (true) {
                ...
                if (obj != aujVar) {
                    ...
                    while (!atomicReferenceFieldUpdater.compareAndSet(aorVar, obj, null)) {
                ...
                do {
                    if (atomicReferenceFieldUpdater.compareAndSet(aorVar, aujVar, this)) {
                        break loop0;
                    }
                } while (atomicReferenceFieldUpdater.get(aorVar) == aujVar);
            }
            if (th == null) {
                return;
            }
