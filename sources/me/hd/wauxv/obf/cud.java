...
public final class cud extends SwitchHook {
    public static final cud a = new cud("PluginHook" /* "PluginHook" /* "PluginHook" /* "PluginHook" /* cnb.z(-485159505754922L)   */);
    ...
    public static final Function1$VarIsObj i = new Function1$VarIsObj(22);
