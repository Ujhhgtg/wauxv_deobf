...
public abstract class zf {
    ...
    public static final Object c(Class cls, final Object[] objArr) {
        if (objArr.length != 0) {
        ...
        final int i3 = 0;
        final int i4 = 1;
        Constructor constructor2 = (Constructor) dfv.ah(new bae(new bae(new bae(la.b(cls.getDeclaredConstructors()), true, new ws(23)), true, new bgf() { // from class: me.hd.wauxv.obf.ze
            ...
            public final Object invoke(Object obj2) {
                ...
                switch (i3) {
                    ...
                    default:
                        ...
                        bzo.q(parameterTypes, "<this>");
                        Object[] objArr2 = objArr;
                        bzo.q(objArr2, "other");
                        int iMin = Math.min(parameterTypes.length, objArr2.length);
                        ArrayList<csm> arrayList = new ArrayList(iMin);
                        boolean z = false;
                        for (int i5 = 0; i5 < iMin; i5++) {
                            arrayList.add(new csm(parameterTypes[i5], objArr2[i5]));
                        }
                        if (arrayList.isEmpty()) {
                            z = true;
                        } else {
                            for (csm csmVar : arrayList) {
                                Class cls2 = (Class) csmVar.a;
                                Object obj3 = csmVar.b;
                                if (obj3 != null || cls2.isPrimitive()) {
                                    if (obj3 != null) {
                                        Class<?> cls3 = obj3.getClass();
                                        if (bzo.f(cls2, Boolean.TYPE)) {
                                            cls2 = Boolean.class;
                                        } else if (bzo.f(cls2, Byte.TYPE)) {
                                            cls2 = Byte.class;
                                        } else if (bzo.f(cls2, Character.TYPE)) {
                                            cls2 = Character.class;
                                        } else if (bzo.f(cls2, Short.TYPE)) {
                                            cls2 = Short.class;
                                        } else if (bzo.f(cls2, Integer.TYPE)) {
                                            cls2 = Integer.class;
                                        } else if (bzo.f(cls2, Long.TYPE)) {
                                            cls2 = Long.class;
                                        } else if (bzo.f(cls2, Float.TYPE)) {
                                            cls2 = Float.class;
                                        } else if (bzo.f(cls2, Double.TYPE)) {
                                            cls2 = Double.class;
                                        } else if (bzo.f(cls2, Void.TYPE)) {
                                            cls2 = Void.class;
                                        }
        ...
        }), true, new bgf() { // from class: me.hd.wauxv.obf.ze
            @Override // me.hd.wauxv.obf.bgf
            public final Object invoke(Object obj2) {
                Constructor constructor3 = (Constructor) obj2;
                switch (i4) {
    ...
    public static final Object d(Constructor constructor, Object[] objArr) {
        ...
        throw new NoSuchMethodError("Could not find a suitable constructor for " + constructor + " with arguments: " + ((Object) strU) + ".");
    }

    public static Object e(Class cls, Object[] objArr) {
        Object objX;
        try {
            objX = c(cls, Arrays.copyOf(objArr, objArr.length));
        } catch (Throwable th) {
            objX = bhu.x(th);
        }
