...
public final /* synthetic */ class byz extends bgr implements IInvokable {
    public static final byz a = new byz(1, dj.class, "inflate" /* "inflate" /* "inflate" /* "inflate" /* cnb.z(-389630843157290L)   */, "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityMainBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityMainBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityMainBinding;" /* "inflate(Landroid/view/LayoutInflater;)Lme/hd/wauxv/databinding/ActivityMainBinding;" /* cnb.z(-389596483418922L)   */, 0);
    ...
    public final Object invoke(Object obj) {
        ...
        throw new NullPointerException("Missing required view with ID: " /* "Missing required view with ID: " /* "Missing required view with ID: " /* "Missing required view with ID: " /* cnb.z(-635436116474666L)   */.concat(viewInflate.getResources().getResourceName(i)));
    }
}
