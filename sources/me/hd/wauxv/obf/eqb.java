...
public final class eqb extends ApiHookItem implements IDexFind {
    public static final eqb a = new eqb();

    public static String b(String str) {
        Method methodBb = StaticHelpers7.toDexMethod(VideoInfoStorage$MethodGetRestoreMp4Path.INSTANCE);
        VideoServiceDexFindHook.INSTANCE.getClass();
        Object objInvoke = methodBb.invoke(VideoServiceDexFindHook.b(), str);
    ...
    public final void dexFind(DexKitBridge dexKitBridge) {
        StaticHelpers7.resolveDexAndCache(VideoInfoStorage$MethodGetRestoreMp4Path.INSTANCE, dexKitBridge, new dos(28));
