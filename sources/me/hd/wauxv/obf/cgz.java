...
public final class cgz extends SwitchHook implements bnb {
    ...
    public final void a(ViewGroup viewGroup) {
        if (getIsEnabled()) {
            View viewV = cnh.v(viewGroup, StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8065) ? "c0g" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8064) ? "bzy" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8063) ? "byw" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8061_PATCH) ? "bxy" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8061) ? "bx_" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8060) ? "bw0" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8058) ? "bvg" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8057) ? "buz" : StaticUtils.isNewerThanArgVerAndPlay(ewh.VER_8056) ? "bu9" : StaticUtils.isNewerThanArgVerAndPlay(ewh.h) ? "btr"  : StaticUtils.isNewerThanArgVerAndPlay(ewh.g) ? "bvm" : StaticUtils.isNewerThanArgVerAndPlay(ewh.f) : StaticUtils.isNewerThanArgVerAndPlay(ewh.e) ? "br2" : StaticUtils.isNewerThanArgVerAndPlay(ewh.d) ? "bqh" : StaticUtils.isNewerThanArgVerAndPlay(ewh.c) ? "bm8" : StaticUtils.isNewerThanArgVerAndPlay(ewh.b) ? "bi0" : StaticUtils.isNewerThanArgVerAndPlay(ewh.a) ? "bdv" : StaticUtils.isNewerThanArgVerAndNotPlay(ewk.c) ? "bkj" : "b4_");
            ...
            layoutParams.setMargins((int) cnh.r(36.0d, imageView.getContext()),
            ...
            imageView.setImageTintList(emc.ai(
                    Color.parseColor(StaticUtils.decryptString(cnh.aa(imageView.getContext()) ? -473146482228010L : -473120712424234L))));
