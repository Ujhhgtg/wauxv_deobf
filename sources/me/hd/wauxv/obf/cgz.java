...
public final class cgz extends doo implements bnb {
    ...
    public final void a(ViewGroup viewGroup) {
        if (z()) {
            ...
            layoutParams.setMargins((int) cnh.r(Double.valueOf(36.0d), imageView.getContext()), ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
            imageView.setLayoutParams(layoutParams);
            imageView.setImageResource(R.drawable.ic_menu_quote_24dp);
            imageView.setImageTintList(emc.ai(Color.parseColor(cnb.z(cnh.aa(imageView.getContext()) ? -473146482228010L : -473120712424234L))));
