...
public final class lx extends SwitchHook implements Runnable {
    public static final lx a = new lx("AutoCleanHook" /* "AutoCleanHook" /* "AutoCleanHook" /* cnb.z(-511217072339754L)  */);
    public static final String b = "杂项" /* "杂项" /* "杂项" /* cnb.z(-511161237764906L)  */;
    public static final String c = "自动瘦身" /* "自动瘦身" /* "自动瘦身" /* cnb.z(-511165532732202L)  */;
    public static final String d = "致敬瘦身模块 'KitsunePie-QQCleaner' " /* "致敬瘦身模块 'KitsunePie-QQCleaner' " /* "致敬瘦身模块 'KitsunePie-QQCleaner' " /* cnb.z(-511126878026538L)  */;
