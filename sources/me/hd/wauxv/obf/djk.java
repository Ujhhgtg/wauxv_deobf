...
public final /* synthetic */ class djk implements bgf {
    ...
    public final Object invoke(Object obj) throws IllegalAccessException, InvocationTargetException {
        ...
        switch (i) {
            ...
            case 1:
                bah bahVar = (bah) obj;
                String[] strArr = {"com.tencent.mm.plugin.sns.ui.listener" /* cnb.z(-56500294777642L) */};
                bahVar.getClass();
                bahVar.a = la.ab(strArr);
                cdj cdjVar = new cdj();
                cdjVar.t("delete comment fail!!! snsInfo is null" /* cnb.z(-53571127081770L) */, "send photo fail, mediaObj is null" /* cnb.z(-53403623357226L) */, "mediaObj is null, send failed!" /* cnb.z(-53824530152234L) */);
                bahVar.d = cdjVar;
                return ensVar;
            case 2:
                bah bahVar2 = (bah) obj;
                String[] strArr2 = {"com.tencent.mm.plugin.sns.ui.listener" /* cnb.z(-56994216016682L) */};
                bahVar2.getClass();
                bahVar2.a = la.ab(strArr2);
                cdj cdjVar2 = new cdj();
                cdjVar2.t("MicroMsg.TimelineOnCreateContextMenuListener" /* cnb.z(-56264071576362L) */, "onMMCreateContextMenu error" /* cnb.z(-56105157786410L) */);
                bahVar2.d = cdjVar2;
                return ensVar;
            case 3:
                ...
                djv djvVar = djv.a;
                String strZ = "过滤" /* cnb.z(-556069415811882L) */;
                djp djpVar = new djp(activity, objArr == true ? 1 : 0);
                djvVar.getClass();
                int i4 = bte.a;
                cde cdeVarT = dqc.bi(activity).t();
                cdeVarT.ab = "addTextOptionMenu" /* cnb.z(-558530432072490L) */;
            ...
            case 6:
                bah bahVar3 = (bah) obj;
                cdj cdjVar3 = new cdj();
                cdj.l(cdjVar3, "com.tencent.mm.plugin.mvvmlist.MvvmList" /* cnb.z(-556339998751530L) */);
                cls3 = Void.class;
                Class<Void> clsBf2 = cnf.bf(dal.b(cls3));
                cdjVar3.r(clsBf2 != null ? clsBf2 : Void.class);
                cdjVar3.t("submitRefreshAll" /* cnb.z(-556168200059690L) */);
                bahVar3.getClass();
                bahVar3.d = cdjVar3;
                return ensVar;
            case 7:
            ...
            case 8:
                ...
                fj fjVar = new fj();
                cdj cdjVar5 = new cdj();
                cdjVar5.t("produceMediaObjByPath" /* cnb.z(-352380591799082L) */, "com.tencent.mm.plugin.sns.model.UploadPackHelper" /* cnb.z(-352268922649386L) */);
                fjVar.f(cdjVar5);
                cdj cdjVar6 = new cdj();
                cdjVar6.t("produceSightByPath" /* cnb.z(-353724916562730L) */, "com.tencent.mm.plugin.sns.model.UploadPackHelper" /* cnb.z(-353660492053290L) */);
                fjVar.f(cdjVar6);
                cdjVar4.j = fjVar;
                bahVar4.getClass();
                bahVar4.d = cdjVar4;
            ...
            case 10:
                ...
                cdjVar7.t("MicroMsg.snsMediaStorage" /* cnb.z(-377939942177578L) */, "convertImg2WxamWithoutZip origPath:%s OutOfMemoryError! rollback" /* cnb.z(-377832567995178L) */);
                bahVar5.getClass();
                bahVar5.d = cdjVar7;
                return ensVar;
            case 11:
            ...
            case 12:
                bag bagVar = (bag) obj;
                String[] strArr3 = {"com.tencent.mm.storage" /* cnb.z(-353810815908650L) */};
                bagVar.getClass();
                bagVar.a = la.ab(strArr3);
                zb zbVar = new zb();
                zbVar.k("timeline" /* cnb.z(-353213815454506L) */, "album_friend" /* cnb.z(-353123621141290L) */, "album_self" /* cnb.z(-353102146304810L) */, "album_stranger" /* cnb.z(-353020541926186L) */, "profile_friend" /* cnb.z(-353007657024298L) */, "profile_stranger" /* cnb.z(-353492988328746L) */, "comment" /* cnb.z(-353419973884714L) */, "comment_detail" /* cnb.z(-353385614146346L) */, "other" /* cnb.z(-353321189636906L) */, "snssight" /* cnb.z(-353278239963946L) */, "fts" /* cnb.z(-353239585258282L) */, "storysight" /* cnb.z(-359235359603498L) */, "storyalbum" /* cnb.z(-359222474701610L) */);
                bagVar.b = zbVar;
                return ensVar;
            case 13:
                View view = (View) obj;
                        ...
                        if (textInputEditText2 != null) {
                            ...
                            if (((TextInputLayout) cnd.aq(viewK, R.id.moduleDialogInputSnsUploadAppInfoPhone)) != null) {
                                ...
                                if (((TextInputLayout) cnd.aq(viewK, R.id.moduleDialogInputSnsUploadAppInfoWindows)) != null) {
                                    ...
                                    dkh.a.getClass();
                                    egVar.d = dkh.i;
                                    bzyVar.t("保存" /* cnb.z(-561786017282858L) */, new amw(new cfx(cemVar, 16), 0));
                                    bzyVar.s("重置" /* cnb.z(-561807492119338L) */, new amw(new cfh(26), 2));
                ...
                throw new NullPointerException("Missing required view with ID: " /* cnb.z(-660565970123562L) */.concat(viewK.getResources().getResourceName(i5)));
            case 14:
                bmm bmmVar = (bmm) obj;
                eog eogVar = eog.a;
            ...
            case 16:
                bah bahVar6 = (bah) obj;
                cdj cdjVar8 = new cdj();
                cdjVar8.t("MicroMsg.UploadPackHelper" /* cnb.z(-561652873296682L) */, "commit sns info ret %d, typeFlag %d sightMd5 %s" /* cnb.z(-561008628202282L) */);
                bahVar6.getClass();
                bahVar6.d = cdjVar8;
                return ensVar;
            case 17:
                ...
                if (materialRadioButton != null) {
                    ...
                    if (materialRadioButton2 != null) {
                        ...
                        if (radioGroup != null) {
                            ...
                            dkl.a.getClass();
                            egVar2.d = dkl.c;
                            bzyVar2.t("保存" /* cnb.z(-548480208599850L) */, new amw(new cfx(bqrVar, 17), 0));
                ...
                throw new NullPointerException("Missing required view with ID: " /* cnb.z(-659878775356202L) */.concat(viewK2.getResources().getResourceName(i6)));
            case 18:
                bmm bmmVar2 = (bmm) obj;
                if (dkk.a.k() == dkj.a.d) {
                    bmmVar2.getClass();
                    ...
                    bzo.o(objInvoke, "null cannot be cast to non-null type kotlin.Boolean" /* cnb.z(-376548372773674L) */);
            ...
            case 19:
                ...
                if (dkk.a.k() == dkj.b.d) {
                    ...
                    if (bool != null ? bool.booleanValue() : false) {
                        ...
                        bzo.o(objInvoke2, "null cannot be cast to non-null type kotlin.String" /* cnb.z(-107696304945962L) */);
            ...
            case 21:
                bah bahVar7 = (bah) obj;
                cdj cdjVar9 = new cdj();
                cdjVar9.t("MicroMsg.snsMediaStorage" /* cnb.z(-548432963959594L) */, "SnsCompressResolutionFor2G" /* cnb.z(-547775833963306L) */, "SnsCompressResolutionFor3G" /* cnb.z(-547694229584682L) */, "SnsCompressResolutionFor4G" /* cnb.z(-548076481674026L) */, "SnsCompressResolutionForWifi" /* cnb.z(-547994877295402L) */);
                bahVar7.getClass();
                bahVar7.d = cdjVar9;
                return ensVar;
            case 22:
            ...
            case 23:
                ...
                cdjVar10.s("compareContent" /* cnb.z(-359033496140586L) */);
                fjVar2.f(cdjVar10);
                cdj cdjVar11 = new cdj();
                cdjVar11.s("op" /* cnb.z(-359020611238698L) */);
                fjVar2.f(cdjVar11);
                cdj cdjVar12 = new cdj();
                fj fjVar3 = new fj();
                cdj cdjVar13 = new cdj();
                cdjVar13.t("getCommentInfo" /* cnb.z(-359523122412330L) */, "com.tencent.mm.plugin.sns.ui.SnsCommentFooter" /* cnb.z(-359441518033706L) */);
                fjVar3.f(cdjVar13);
                cdj cdjVar14 = new cdj();
                cdjVar14.t("initCommentInfo" /* cnb.z(-359295489145642L) */, "com.tencent.mm.plugin.sns.ui.SnsSingleTextViewUI" /* cnb.z(-358677013855018L) */);
                fjVar3.f(cdjVar14);
                cdjVar12.j = fjVar3;
                fjVar2.f(cdjVar12);
                zbVar2.f = fjVar2;
            ...
            case 28:
                bah bahVar8 = (bah) obj;
                String[] strArr4 = {"com.tencent.mm.plugin.sns.model" /* cnb.z(-359858129861418L) */};
                bahVar8.getClass();
                bahVar8.a = la.ab(strArr4);
                cdj cdjVar15 = new cdj();
                cdjVar15.t("getSnsVideoFullPath" /* cnb.z(-356971911838506L) */, "com.tencent.mm.plugin.sns.model.SnsVideoLogic" /* cnb.z(-356920372230954L) */);
                bahVar8.d = cdjVar15;
                return ensVar;
            default:
                bah bahVar9 = (bah) obj;
                String[] strArr5 = {"com.tencent.mm.plugin.sns.model" /* cnb.z(-357255379680042L) */};
                bahVar9.getClass();
                bahVar9.a = la.ab(strArr5);
                cdj cdjVar16 = new cdj();
                cdjVar16.t("getDownloadVideoPath" /* cnb.z(-357117940726570L) */, "com.tencent.mm.plugin.sns.model.SnsVideoLogic" /* cnb.z(-356512350337834L) */);
                bahVar9.d = cdjVar16;
                return ensVar;
        }
    }
