...
public final class aid {
    ...
    static {
        aid aidVar = new aid("SUB" /* "SUB" /* "SUB" /* cnb.z(-422560357415722L)  */, 0, -1);
        a = aidVar;
        aid aidVar2 = new aid("DEFAULT" /* "DEFAULT" /* "DEFAULT" /* cnb.z(-422577537284906L)  */, 1, 0);
        b = aidVar2;
        aid aidVar3 = new aid("ADD" /* "ADD" /* "ADD" /* cnb.z(-422543177546538L)  */, 2, 1);
        c = aidVar3;
