...
public final class ri implements ajh, ako, crt {
    ...
    public boolean g() {
        ByteBuffer byteBuffer = this.b;
        if (byteBuffer == null) {
            throwLateinitPropNotInitYet("buffer" /* "buffer" /* "buffer" /* "buffer" /* cnb.z(-22574348106538L)   */);
            throw null;
        }
        ...
        throwLateinitPropNotInitYet("buffer" /* "buffer" /* "buffer" /* "buffer" /* cnb.z(-23076859280170L)   */);
        throw null;
    }
