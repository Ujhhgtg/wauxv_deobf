...
public abstract class baf {
        ...
        while (true) {
            ...
            if (i19 >= length) {
                ...
                while (i24 >= i29) {
                    ...
                    if (i26 > i3 && str2.charAt((i + i24) - i3) == str4.charAt(i28 - 1) && !e(i30 - 1, str3, str4) && i26 + 1 > iArr6[i24][i30]) {
                        i30 = i28;
                    }
    ...
    /* JADX WARN: Found duplicated region for block: B:34:0x004f A[FALL_THROUGH, RETURN] */
