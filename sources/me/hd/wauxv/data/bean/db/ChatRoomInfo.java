...
public final class ChatRoomInfo {
    ...
    public String toString() {
        ...
        yg.u(sb, this.roomowner, -10075993275178L);
        yg.u(sb, this.selfDisplayName, -10011568765738L);
        yg.u(sb, this.chatroomnotice, -9951439223594L);
        yg.u(sb, this.xmlChatroomnotice, -10393820855082L);
        yg.u(sb, this.chatroomnoticeEditor, -10290741639978L);
        yg.u(sb, this.associateOpenIMRoomName, -10191957392170L);
        ...
        dkz.ac(sb, this.chatroomdataflag, -15564961479466L);
        dkz.ac(sb, this.chatroomStatus, -15436112460586L);
        dkz.ac(sb, this.openIMRoomMigrateStatus, -15887084026666L);
        dkz.ac(sb, this.spamStatus, -15809774615338L);
