...
public final class RContactInfo {
    ...
    public String toString() {
        ...
        sb.append("RContactInfo(username=" /* "RContactInfo(username=" /* "RContactInfo(username=" /* cnb.z(-16638703303466L)  */);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.username, -16591458663210L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.alias, -16501264349994L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.conRemark, -17029545327402L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.domainList, -16952235916074L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.nickname, -16935056046890L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.pyInitial, -16862041602858L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.quanPin, -16831976831786L);
        StaticHelpers6.ac(sb, this.showHead, -13997298416426L);
        StaticHelpers6.ac(sb, this.type, -13962938678058L);
        sb.append(this.uiType);
        sb.append(", weiboFlag=" /* ", weiboFlag=" /* ", weiboFlag=" /* cnb.z(-13937168874282L)  */);
        StaticHelpers6.ac(sb, this.weiboFlag, -13864154430250L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.weiboNickname, -13791139986218L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.conRemarkPYFull, -14293651159850L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.conRemarkPYShort, -14173392075562L);
        sb.append(Arrays.toString(this.lvbuff));
        sb.append(", verifyFlag=" /* ", verifyFlag=" /* ", verifyFlag=" /* cnb.z(-14147622271786L)  */);
        StaticHelpers6.ac(sb, this.verifyFlag, -14070312860458L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.encryptUsername, -13456132537130L);
        StaticHelpers6.ac(sb, this.chatroomFlag, -13387413060394L);
        StaticHelpers6.ac(sb, this.deleteFlag, -13310103649066L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.contactLabelIds, -13262859008810L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.descWordingId, -13739600378666L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.openImAppid, -13675175869226L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.sourceExtInfo, -13602161425194L);
        yg.decryptVar2UsingCnbZAndConcatToVar1(sb, this.ticket, -13507672144682L);
        sb.append(this.usernameFlag);
        sb.append(", contactExtra=" /* ", contactExtra=" /* ", contactExtra=" /* cnb.z(-15088220109610L)  */);
        sb.append(Arrays.toString(this.contactExtra));
        sb.append(", createTime=" /* ", createTime=" /* ", createTime=" /* cnb.z(-15019500632874L)  */);
