...
import me.hd.wauxv.obf.LifeEventEnum;
...
public final class ProcessLifecycleInitializer implements bpf {
    ...
    public final Object b(Context context) {
        ...
        throwIfVar1IsNull(factoryPoolsVarJ, "getInstance(...)");
        if (!((HashSet) factoryPoolsVarJ.f).contains(ProcessLifecycleInitializer.class)) {
        ...
        cvtVar.g.m(LifeEventEnum.ON_CREATE);
