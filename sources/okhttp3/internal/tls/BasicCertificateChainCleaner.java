...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        bzo.p(objRemoveFirst, "queue.removeFirst()");
        arrayList.add(objRemoveFirst);
        boolean z = false;
        for (int i = 0; i < 9; i++) {
            Object obj = arrayList.get(arrayList.size() - 1);
            bzo.o(obj, "null cannot be cast to non-null type java.security.cert.X509Certificate");
            ...
            if (x509CertificateFindByIssuerAndSignature != null) {
                ...
                do {
                    ...
                    Object next = it.next();
                    bzo.o(next, "null cannot be cast to non-null type java.security.cert.X509Certificate");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && bzo.f(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
