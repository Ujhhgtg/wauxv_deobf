...
final class FieldWriterCharValField<T> extends FieldWriter<T> {
    ...
    public FieldWriterCharValField(String str, int i, long j, String str2, String str3, Field field) {
    ...
    public char getFieldValueChar(Object obj) {
        ...
        try {
            ...
            return j != -1 ? JDKUtils.UNSAFE.getChar(obj, j) : this.field.getChar(obj);
