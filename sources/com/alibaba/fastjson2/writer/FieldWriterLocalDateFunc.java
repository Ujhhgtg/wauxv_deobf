...
final class FieldWriterLocalDateFunc<T> extends FieldWriterObjectFinal<T> {
    ...
    public FieldWriterLocalDateFunc(String str, int i, long j, String str2, String str3, Type type, Class cls, Field field, Method method, Function function) {
    ...
    public boolean write(JSONWriter jSONWriter, T t) {
        LocalDate localDate = (LocalDate) this.function.apply(t);
        if (localDate == null) {
