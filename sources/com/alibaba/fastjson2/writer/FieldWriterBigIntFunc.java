...
final class FieldWriterBigIntFunc<T> extends FieldWriter<T> {
    ...
    public FieldWriterBigIntFunc(String str, int i, long j, String str2, String str3, Field field, Method method, Function<T, BigInteger> function) {
    ...
    public boolean write(JSONWriter jSONWriter, T t) {
        BigInteger bigIntegerApply = this.function.apply(t);
