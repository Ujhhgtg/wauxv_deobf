...
final class FieldWriterObjectFunc<T> extends FieldWriterObject<T> {
    ...
    public FieldWriterObjectFunc(String str, int i, long j, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Function function) {
