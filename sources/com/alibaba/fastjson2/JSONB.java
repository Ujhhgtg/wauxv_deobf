...
public interface JSONB {
    ...
    public interface IO {
        ...
        static int writeBoolean(byte[] bArr, int i, Boolean bool) {
            bArr[i] = bool == null ? Constants.BC_NULL : bool.booleanValue() ? Constants.BC_TRUE : Constants.BC_FALSE;
            return i + 1;
        }
    ...
    static String typeName(byte b) {
        if (b == 72) {
            return bjs.j(b, new StringBuilder("INT32 "));
        }
        if (b == 127) {
            return bjs.j(b, new StringBuilder("SYMBOL "));
        }
        switch (b) {
            case -111:
                return bjs.j(b, new StringBuilder("BINARY "));
            case -110:
                return bjs.j(b, new StringBuilder("TYPED_ANY "));
            case -109:
                return bjs.j(b, new StringBuilder("REFERENCE "));
            default:
                switch (b) {
                    case -91:
                        return bjs.j(b, new StringBuilder("OBJECT_END "));
                    case -90:
                        return bjs.j(b, new StringBuilder("OBJECT "));
                    case -89:
                        return bjs.j(b, new StringBuilder("LOCAL_TIME "));
                    case -88:
                        return bjs.j(b, new StringBuilder("LOCAL_DATETIME "));
                    case -87:
                        return bjs.j(b, new StringBuilder("LOCAL_DATE "));
                    case -86:
                        return bjs.j(b, new StringBuilder("TIMESTAMP_WITH_TIMEZONE "));
                    case -85:
                        return bjs.j(b, new StringBuilder("TIMESTAMP_MILLIS "));
                    case -84:
                        return bjs.j(b, new StringBuilder("TIMESTAMP_SECONDS "));
                    case -83:
                        return bjs.j(b, new StringBuilder("TIMESTAMP_MINUTES "));
                    case -82:
                        return bjs.j(b, new StringBuilder("TIMESTAMP "));
                    case -81:
                        return bjs.j(b, new StringBuilder("NULL "));
                    case -80:
                        return bjs.j(b, new StringBuilder("FALSE "));
                    case -79:
                        return bjs.j(b, new StringBuilder("TRUE "));
                    case -78:
                    case -77:
                    case -76:
                    case -75:
                        return bjs.j(b, new StringBuilder("DOUBLE "));
                    case -74:
                    case -73:
                        return bjs.j(b, new StringBuilder("FLOAT "));
                    case -72:
                    case -71:
                        return bjs.j(b, new StringBuilder("DECIMAL "));
                    case -70:
                    case -69:
                        return bjs.j(b, new StringBuilder("BIGINT "));
                    case -68:
                        return bjs.j(b, new StringBuilder("INT16 "));
                    case -67:
                        return bjs.j(b, new StringBuilder("INT8 "));
                    case -66:
                    case -65:
                        return bjs.j(b, new StringBuilder("INT64 "));
                    default:
                        switch (b) {
                            case 122:
                                return bjs.j(b, new StringBuilder("STR_UTF8 "));
                            case 123:
                                return bjs.j(b, new StringBuilder("STR_UTF16 "));
                            case 124:
                                return bjs.j(b, new StringBuilder("STR_UTF16LE "));
                            case 125:
                                return bjs.j(b, new StringBuilder("STR_UTF16BE "));
                            default:
                                return (b < -108 || b > -92) ? (b < 73 || b > 121) ? (b < -16 || b > 47) ? (b < 48 || b > 63) ? (b < 64 || b > 71) ? (b < -40 || b > -17) ? (b < -56 || b > -41) ? (b < -64 || b > -57) ? Integer.toString(b) : bjs.j(b, new StringBuilder("INT64 ")) : bjs.j(b, new StringBuilder("INT64 ")) : bjs.j(b, new StringBuilder("INT64 ")) : bjs.j(b, new StringBuilder("INT32 ")) : bjs.j(b, new StringBuilder("INT32 ")) : bjs.j(b, new StringBuilder("INT32 ")) : bjs.j(b, new StringBuilder("STR_ASCII ")) : bjs.j(b, new StringBuilder("ARRAY "));
                        }
                }
        }
    }
