...
final class FieldReaderInt32Func<T, V> extends FieldReader<T> {
    ...
    public FieldReaderInt32Func(String str, Class<V> cls, int i, long j, String str2, Locale locale, Object obj, JSONSchema jSONSchema, Method method, BiConsumer<T, V> biConsumer) {
