...
final class FieldReaderBoolValueMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderBoolValueMethod(String str, int i, long j, String str2, Boolean bool, JSONSchema jSONSchema, Method method) {
        Class cls = Boolean.TYPE;
        super(str, cls, cls, i, j, str2, null, bool, jSONSchema, method, null, null);
    }
