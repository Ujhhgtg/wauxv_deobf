...
final class FieldReaderAtomicBooleanMethodReadOnly<T> extends FieldReader<T> {
    public FieldReaderAtomicBooleanMethodReadOnly(String str, Class cls, int i, JSONSchema jSONSchema, Method method) {
    ...
    public void accept(T t, Object obj) {
        ...
        try {
            AtomicBoolean atomicBoolean = (AtomicBoolean) this.method.invoke(t, null);
