...
final class FieldReaderInt8ValueField<T> extends FieldReaderObjectField<T> {
    public FieldReaderInt8ValueField(String str, Class cls, int i, long j, String str2, Byte b, JSONSchema jSONSchema, Field field) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t) {
        ...
        try {
            this.field.setByte(t, (byte) int32Value);
        } catch (Exception e) {
