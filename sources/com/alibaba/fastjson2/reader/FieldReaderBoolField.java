...
final class FieldReaderBoolField<T> extends FieldReaderObjectField<T> {
    public FieldReaderBoolField(String str, Class cls, int i, long j, String str2, Boolean bool, JSONSchema jSONSchema, Field field) {
    ...
    public void accept(T t, int i) {
        accept(t, TypeUtils.toBoolean(Integer.valueOf(i)));
    }
