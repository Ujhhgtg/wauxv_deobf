...
final class FieldReaderBigIntegerMethod<T> extends FieldReaderObject<T> {
    public FieldReaderBigIntegerMethod(String str, Type type, Class cls, int i, long j, String str2, Locale locale, BigInteger bigInteger, JSONSchema jSONSchema, Method method) {
