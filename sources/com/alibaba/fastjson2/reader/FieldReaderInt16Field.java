...
final class FieldReaderInt16Field<T> extends FieldReaderObjectField<T> {
    public FieldReaderInt16Field(String str, Class cls, int i, long j, String str2, Short sh, JSONSchema jSONSchema, Field field) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t) {
        Short shValueOf = jSONReader.wasNull() ? null : Short.valueOf((short) jSONReader.readInt32Value());
        JSONSchema jSONSchema = this.schema;
        if (jSONSchema != null) {
            jSONSchema.assertValidate(shValueOf);
        }
        try {
            this.field.set(t, shValueOf);
        } catch (Exception e) {
    ...
    public void accept(T t, int i) {
        accept(t, Short.valueOf((short) i));
    }

    @Override // com.alibaba.fastjson2.reader.FieldReaderObjectField, com.alibaba.fastjson2.reader.FieldReaderObject, com.alibaba.fastjson2.reader.FieldReader
    public void accept(T t, long j) {
        accept(t, Short.valueOf((short) j));
    }
