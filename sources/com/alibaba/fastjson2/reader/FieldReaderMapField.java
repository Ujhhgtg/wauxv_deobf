...
public class FieldReaderMapField<T> extends FieldReaderObjectField<T> {
    ...
    public FieldReaderMapField(String str, Type type, Class cls, int i, long j, String str2, Locale locale, Object obj, JSONSchema jSONSchema, Field field, String str3, BiConsumer biConsumer) {
