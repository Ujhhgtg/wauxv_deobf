...
final class FieldReaderInt8Func<T, V> extends FieldReader<T> {
    ...
    public FieldReaderInt8Func(String str, Class<V> cls, int i, long j, String str2, Locale locale, Object obj, JSONSchema jSONSchema, Method method, BiConsumer<T, V> biConsumer) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t) throws Exception {
        ...
        JSONSchema jSONSchema = this.schema;
        if (jSONSchema != null) {
            jSONSchema.assertValidate(bValueOf);
        }
        this.function.accept(t, bValueOf);
    }
