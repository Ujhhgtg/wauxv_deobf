...
public class f {
    ...
    public static final String ar = bd.b().b(bd.t);
    public static final String as = bd.b().b(bd.u);
    ...
    public static final String[] aN = {ay, az, "_$!du", "_$!c", ae, "_$!sp", "event_name", "token", "time", "ip", bt.O, "region", "city", "browser", bt.x, bt.F, "device_version", bt.ac, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
