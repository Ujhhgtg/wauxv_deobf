...
public final class ByteArrayAnnotatedOutput implements AnnotatedOutput, sh {
    ...
    private void ensureCapacity(int i) {
        byte[] bArr = this.data;
        if (bArr.length < i) {
            byte[] bArr2 = new byte[(i * 2) + DEFAULT_SIZE];
    ...
    /* JADX WARN: Found duplicated region for block: B:10:0x0017 A[PHI: r1
    ...
    public void enableAnnotations(int i, boolean z) {
        ...
        this.annotations = new ArrayList<>(DEFAULT_SIZE);
    ...
    @Override // com.android.dx.util.Output, me.hd.wauxv.obf.sh
