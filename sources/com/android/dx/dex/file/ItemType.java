...
public enum ItemType implements ToHuman {
    ...
    TYPE_TYPE_LIST(q.a.a, "type_list"),
    TYPE_ANNOTATION_SET_REF_LIST(q.a.b, "annotation_set_ref_list"),
    TYPE_ANNOTATION_SET_ITEM(q.a.c, "annotation_set_item"),
    TYPE_CLASS_DATA_ITEM(8192, "class_data_item"),
    TYPE_CODE_ITEM(q.a.r, "code_item"),
    TYPE_STRING_DATA_ITEM(q.a.s, "string_data_item"),
    TYPE_DEBUG_INFO_ITEM(q.a.t, "debug_info_item"),
    TYPE_ANNOTATION_ITEM(q.a.u, "annotation_item"),
    TYPE_ENCODED_ARRAY_ITEM(q.a.v, "encoded_array_item"),
    ...
    ItemType(int i, String str) {
        this.mapValue = i;
        this.typeName = str;
        this.humanName = (str.endsWith("_item") ? yg.j(str, 5, 0) : str).replace('_', ' ');
    }
